...
class APIConnect:
    ...
    def __init__(self, ApiKey, Password, reqID, downloadContract: bool, conf = None) -> None:
        ...
        AppIdKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhcHAiOjAsImZmIjoiVyIsImJkIjoid2ViLXBjIiwibmJmIjoxNjk4OTkzODgzLCJzcmMiOiJlbXRtdyIsImF2IjoiMi4wLjQiLCJhcHBpZCI6ImI1YTlmYzQ4YzVkNTY3MjIzMzBhMmZmYTc4MThkNTM1IiwiaXNzIjoiZW10IiwiZXhwIjoxNjk5MDM2MjAwLCJpYXQiOjE2OTg5OTQxODN9.Sev3zJC33KC5DrcYnbAYCiACupyJ-GwT6lyIEZNRrlE"
