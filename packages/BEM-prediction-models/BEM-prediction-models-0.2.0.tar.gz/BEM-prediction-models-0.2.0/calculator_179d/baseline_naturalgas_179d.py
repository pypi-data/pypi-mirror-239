import calculate_common_features as ccf
import pandas as pd
import numpy as np
...
class baseline_naturalgas_179d():
    ...
    def read_proposed_model(self):
        ...
        with open(r'./model_files/'+ model_file,'rb') as f:
            model = joblib.load(f)
    ...
    def create_input_array(self, calculator_user_inputs):
        ...
        input_array = np.array(
            [[
                ...
                calculator_user_inputs['gas_coil_average_efficiency'],
                sa_to_vol_ratio,
                ...
                calculator_user_inputs['water_heating_energy_factor']
            ]]
        )
