import proposed_electricity_179d as pe179d
import baseline_electricity_179d as be179d
import proposed_naturalgas_179d as pn179d
import baseline_naturalgas_179d as bn179d
import numpy as np
import sys
import json
...
def calculate_cost_and_cost_savings(model_outputs,property_info):
    ...
    kBTU_to_MMBTU = 1./1000
    
    ##calculate costs
    #baseline costs
    baseline_179d_electricity_cost = (
        property_info['electricity_rate']*
