...
class Signals_RobotOutputSignal(rebrick.Physics.Signals_OutputSignal):
    ...
    def create(source_angle_signals, source_angular_velocity_signals, source):
        r"""
        create(Physics_Signals_RealOutputSignal_Vector source_angle_signals, Physics_Signals_RealOutputSignal_Vector source_angular_velocity_signals, std::shared_ptr< Physics::Signals::Output > source) -> std::shared_ptr< Robotics::Signals::RobotOutputSignal >

        Parameters
        ----------
        source_angle_signals: std::vector< std::shared_ptr< Physics::Signals::RealOutputSignal >,std::allocator< std::shared_ptr< Physics::Signals::RealOutputSignal > > >
        source_angular_velocity_signals: std::vector< std::shared_ptr< Physics::Signals::RealOutputSignal >,std::allocator< std::shared_ptr< Physics::Signals::RealOutputSignal > > >
        source: std::shared_ptr< Physics::Signals::Output >

        """
        return _RoboticsSwig.Signals_RobotOutputSignal_create(source_angle_signals, source_angular_velocity_signals, source)
...
def Signals_RobotOutputSignal_create(source_angle_signals, source_angular_velocity_signals, source):
    r"""
    Signals_RobotOutputSignal_create(Physics_Signals_RealOutputSignal_Vector source_angle_signals, Physics_Signals_RealOutputSignal_Vector source_angular_velocity_signals, std::shared_ptr< Physics::Signals::Output > source) -> std::shared_ptr< Robotics::Signals::RobotOutputSignal >
