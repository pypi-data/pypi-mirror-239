...
def setup_openai_coding_llm(cosmo):
    """
        ...
        try:
            ...
            if cosmo.context_window:
                messages = tt.trim(
                    messages=messages,
                    system_message=system_message,
                    max_tokens=cosmo.context_window,
                )
            else:
                ...
                # We just need to deal with it.
                    ...
                    if "name" in accumulated_deltas["function_call"]:
                        print(
                            ...
                            "\nPlease open an issue and provide the above info at: https://github.com/KillianLucas/open-cosmo",
                        )
