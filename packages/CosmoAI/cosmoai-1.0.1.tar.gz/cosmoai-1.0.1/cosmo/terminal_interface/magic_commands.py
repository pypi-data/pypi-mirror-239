...
def handle_count_tokens(self, prompt):
    ...
    outputs.append(
        f"**Note**: This functionality is currently experimental and may not be accurate. Please report any issues you find to the [Open Cosmo GitHub repository](https://github.com/KillianLucas/open-cosmo)."
    )
