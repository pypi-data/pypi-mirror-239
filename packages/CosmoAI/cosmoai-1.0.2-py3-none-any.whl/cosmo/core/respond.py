...
from ..code_cosmos.create_code_cosmo import create_code_cosmo
        ...
        if "code" in cosmo.messages[-1]:
            ...
            try:
                ...
                if language in language_map:
                    ...
                    # This still prints the code but don't allow code to run. Let's Open-Cosmo know through output message
                    error_output = f"Error: Open Cosmo does not currently support {language}."
                    print(error_output)
