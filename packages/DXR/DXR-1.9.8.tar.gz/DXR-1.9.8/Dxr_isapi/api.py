...
class CreateDevice:
    ...
    def __init__(self, host=None, port=DEFAULT_PORT,
        ...
        if self._strict_isapi:
            ...
            self.stream_url = '%s/ISAPI/Streaming/channels/103' % self._base
...
#            self._xml_namespace = "{http://www.hikvision.com/ver10/XMLSchema}"
    ...
    def set_videoParam(self, channel='103' ,videoCodingType='1'):
            ...
            <StreamingChannel xmlns="http://www.hikvision.com/ver20/XMLSchema" version="2.0">
                ...
                <Transport>
                    ...
                    <Multicast>
                        ...
                        <videoDestPortNo>8872</videoDestPortNo>
                        <audioDestPortNo>8874</audioDestPortNo>
                    </Multicast>
                    <Security>
                        <enabled>true</enabled>
                    ...
                    <SRTPMulticast>
                        <SRTPVideoDestPortNo>18872</SRTPVideoDestPortNo>
                        <SRTPAudioDestPortNo>18874</SRTPAudioDestPortNo>
                    </SRTPMulticast>
                </Transport>
                <Audio>
                    <enabled>true</enabled>
                ...
                <Video>
                    ...
                    <videoCodecType>{videoCodecType}</videoCodecType>
        ...
        data_xml = data_xml.format(videoCodecType=videoCodingType)
