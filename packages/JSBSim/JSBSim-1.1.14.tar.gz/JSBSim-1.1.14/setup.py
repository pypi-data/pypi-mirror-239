...
#
# Copyright (c) 2014-2023 Bertrand Coconnier
#
...
if compiler.compiler_type == 'unix':
    cpp_compile_flag = ['-std=c++11', '-DNDEBUG']
    cpp_link_flags = []
