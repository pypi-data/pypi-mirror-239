...
class HomeScreen:
    ...
    def initialize_level_editor(
        ...
        level_editor.tileGrid.tileGrid = map_data
        level_editor.tileGrid.offgrid_tiles = offgrid
        # Add the recently opened file to the list
        self.add_to_recently_opened(save_destination)
        # Save the updated list of recently opened files
        self.save_recently_opened_files()
...
class LevelEditor:
    def __init__(
        ...
        self.tile_group = 0
        self.tile_id = 0
        self.tileGrid = TileGrid(map_name, self, self.assets, tileSize=int(tilesize))
