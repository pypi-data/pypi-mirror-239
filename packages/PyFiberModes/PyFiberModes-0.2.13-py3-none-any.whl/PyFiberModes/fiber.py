...
class Fiber(object):
    ...
    def initialize_layers(self) -> None:
        ...
        for idx, (layer_type, fp_, m_, material_parameter) in enumerate(enumerator):
            ...
            layer = geometry.__dict__[layer_type](
                ...
                *fp_,
                ...
                cm=self.material_types[-1],
                cmp=self.material_parameters[-1]
            )
    ...
    def fixedMatFiber(self, wavelength: float):
        ...
        fiber = Fiber(
            ...
            cutoff_solver=self.cutoff_solver.__class__,
            neff_solver=self.neff_solver.__class__
        )
...
def load_fiber(fiber_name: str, wavelength: float = None):
    ...
    fiber_dict = loader.load_fiber_as_dict(fiber_name=fiber_name, wavelength=wavelength, order='out-to-in')
