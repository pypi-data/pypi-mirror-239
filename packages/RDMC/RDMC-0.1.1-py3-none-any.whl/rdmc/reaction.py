...
class Reaction:
    ...
    def is_trivial(self):
        """
        Whether the reaction is trivial (reactant and product are exactly the same including atom mapping).
        """
        return self.reactant_complex.ToSmiles(removeAtomMap=False, removeHs=False) \
            == self.product_complex.ToSmiles(removeAtomMap=False, removeHs=False)
