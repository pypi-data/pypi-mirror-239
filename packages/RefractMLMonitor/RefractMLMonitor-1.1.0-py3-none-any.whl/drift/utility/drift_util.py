...
def update_alert_info(alert_data):
    ...
    temp['recipe'] = plugin_name ; message = temp["message"]
    ...
    try:
        ...
        if refract_source == "model":
            ...
            project_name = [item["field_value"] for item in model_config if item['field_id']=="project_name"][0]
            workflow_name = [item["field_value"] for item in model_config if item['field_id']=="workflow_name"][0]
            temp_data = {
                    "description": {
            ...
            message = project_name +" - "+ workflow_name +" - "+ message
