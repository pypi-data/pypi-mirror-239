  ...
  function testRows($rows, options) {
    ...
    for (let i = 0; i < $rows.length; i++) {
      ...
      for (let j = 0; j < values; j++) {
        expect($cols.eq(valueStartIndex + j).text().trim()).toEqual(values[j]);
      }
    }
  }
  let view;
  ...
  describe('Render', function () {
    ...
    it('Updates when collection reset', function () {
      ...
      testRows($table.find('tbody tr'), {
        rowOptions: [{
          values: ['Commit message 1', 'r1', 'Example Author']
        }, {
          values: ['Commit message 2', 'r2', 'Example Author']
        }]
      });
      ...
      testRows($table.find('tbody tr'), {
        rowOptions: [{
          expanded: false,
          values: ['Commit message 4', 'r4', 'Example Author']
        }]
      });
    });
    ...
    it('With Inter-Commit Diff and Expand/Collapse Controls', function () {
      ...
      testRows($table.find('tbody tr'), {
        ...
        rowOptions: [{
          ...
          values: ['Long commit message', 'r1', 'Example Author']
        }, {
          tipSelected: true,
          values: ['Commit message 2', 'r2', 'Example Author']
        }]
    ...
    it('With base and tip commit IDs set', function () {
      ...
      testRows($table.find('tbody tr'), {
        ...
        rowOptions: [{
          ...
          baseSelected: true,
          tipSelected: true,
          values: ['Commit message 3', 'r3', 'Example Author']
        }, {
          baseDisabled: true,
          values: ['Commit message 4', 'r4', 'Example Author']
        }]
