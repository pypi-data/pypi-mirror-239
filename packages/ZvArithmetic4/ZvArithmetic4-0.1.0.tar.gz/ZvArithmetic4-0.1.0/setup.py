...
setup(
    ...
    version='0.1.0',
    license='MIT',
    description='Official Zv Arithmetic Python SDK',
    ...
    url = 'https://github.com/zvolv/python-zvolv-sdk',
    download_url = 'https://github.com/zvapi/python-zv-sdk/archive/refs/heads/main.zip',
