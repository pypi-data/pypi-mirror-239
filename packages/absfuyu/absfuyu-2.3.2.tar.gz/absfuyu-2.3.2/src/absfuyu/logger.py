...
Version: 1.2.0
Last update: 02/11/2023 (mm/dd/yyyy)
...
_add_logging_level(level_name="TRACE", level_num=LogLevel.TRACE) # Add TRACE log level
_add_logging_level(level_name="EXTREME", level_num=LogLevel.EXTREME) # Add EXTREME log level
