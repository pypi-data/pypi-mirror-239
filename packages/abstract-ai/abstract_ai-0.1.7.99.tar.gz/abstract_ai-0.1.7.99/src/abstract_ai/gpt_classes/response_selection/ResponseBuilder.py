...
class SaveManager:
    ...
    def create_unique_file_name(self):
        base_name = f"{os.path.splitext(self.title)[0]}.json"
        index = 1
...
class ResponseManager:
    ...
    def send_query(self):
        ...
        self.api_response = get_any_valuesafe_json_loads((self.content),'api_response')
        if get_any_value(self.content,'prompt_as_previous'):
