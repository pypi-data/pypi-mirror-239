...
class AbstractWindowManager:
    ...
    def set_window_size(max_size=None,set_current=True,height=0.90,width=0.90):
    ...
    def add_window(self, window_name=None, title=None, default_name=True, 
        ...
        self.global_windows.append({"name":window_name,"method":make_component('Window', title=title, *args, **kwargs),"event":False,"values":False,"current":current,**sizes})
