...
with agilicus_api.ApiClient(configuration) as api_client:
    ...
    api_instance = issuers_api.IssuersApi(api_client)
    org_id = "1234" # str | Organisation Unique identifier
    issuer_upstream_hostname = "issuer_upstream_hostname_example" # str | upstream hostname (optional)
    ...
    try:
        # Validate upstream issuer
        api_instance.validate_upstream(org_id, issuer_upstream_hostname=issuer_upstream_hostname)
    except agilicus_api.ApiException as e:
        print("Exception when calling IssuersApi->validate_upstream: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **org_id** | **str**| Organisation Unique identifier |
 **issuer_upstream_hostname** | **str**| upstream hostname | [optional]
