...
def dev(name:str, port:int, host:str, reload:bool, worker:str, threads:int):
...
@click.argument("name", default="main:app", type=str, nargs=1, required=False)
def prod(name:str, port:int, host:str):
    """Spins up a Aiohttp production server which serves the app."""
    from aiohttp.web import run_app
    from importlib import import_module
    module, app = name.split(":")
