...
class IcebergHistoricalConnection(HistoricalConnectionBase):
    ...
    _calatog_name: Incomplete
    _namespace_name: Incomplete
    def connect(self, app_name: str = ..., calatog_name: str = ..., namespace_name: str = ..., master_node: str = ..., log_level: str = ..., configs: dict[str, str] | None = ..., **kwargs: Any) -> None:
        """
    ...
    def _process_table_description_type(self, data_type: str) -> str | ComplexType: ...
