...
class GroupChat(Chat):
    ...
    _top_messages_rendered = None
    @property
    def _top_messages(self):
        if not self._top_messages_rendered:
            messages = []
            # 任务提示
            ...
            self._top_messages_rendered = messages
        return self._top_messages_rendered