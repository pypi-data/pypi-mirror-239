...
if False:
    ...
    for jid, source_details in testbed_jobs.items():
        ...
        jtr_candidates = MySQLHelpers.get_TopN_JTR('database', jid)
    ...
    # =================
    # Generate QA sourced jobs record
    filePath = "./Candidate_Explanation_V2/Experiment_Stuffs/Expl_Quality_Analysis"
    filter_dict = {
        "JobCreatedEmail": ['dsqatesting@leoforce.com', 'sreevally.pasumarthy@leoforce.com'],
        "JobCreatedDate": ["27-Oct-2023, 0:0:0 IST", "07-Nov-2023, 0:0:0 IST"]
    }
    _testbed = CreateQATestbed(job_ids=range(380000, 384000))
    _testbed.arya_sourced_jobs_record(filter_dict, save_path=filePath)
# ==================================
