...
def test_order():
    assert tests.lib.square(2) == 4

    aspectp.before(tests.lib.square, tests.advice.order_before)
    aspectp.around(tests.lib.square, tests.advice.order_around)
    aspectp.after(tests.lib.square, tests.advice.order_after)
    aspectp.error(tests.lib.square, tests.advice.order_error)
