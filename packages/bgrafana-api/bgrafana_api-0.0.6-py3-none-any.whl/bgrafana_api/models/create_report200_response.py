...
class CreateReport200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateReport200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateReport200Response:
        """Create an instance of CreateReport200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateReport200Response.parse_obj(obj)

        _obj = CreateReport200Response.parse_obj({
            "id": obj.get("id"),
