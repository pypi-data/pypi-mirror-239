...
class NotifierConfig(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NotifierConfig:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NotifierConfig:
        """Create an instance of NotifierConfig from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NotifierConfig.parse_obj(obj)

        _obj = NotifierConfig.parse_obj({
