...
class PauseAlertCommand(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PauseAlertCommand:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PauseAlertCommand:
        """Create an instance of PauseAlertCommand from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PauseAlertCommand.parse_obj(obj)

        _obj = PauseAlertCommand.parse_obj({
