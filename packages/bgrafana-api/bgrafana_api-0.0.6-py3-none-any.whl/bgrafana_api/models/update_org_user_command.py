...
class UpdateOrgUserCommand(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateOrgUserCommand:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateOrgUserCommand:
        """Create an instance of UpdateOrgUserCommand from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateOrgUserCommand.parse_obj(obj)

        _obj = UpdateOrgUserCommand.parse_obj({
            "role": obj.get("role")
        })
        return _obj
