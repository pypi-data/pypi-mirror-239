...
class AddPermissionDTO(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddPermissionDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddPermissionDTO:
        """Create an instance of AddPermissionDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddPermissionDTO.parse_obj(obj)

        _obj = AddPermissionDTO.parse_obj({
