...
class CreateServiceAccountForm(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateServiceAccountForm:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateServiceAccountForm:
        """Create an instance of CreateServiceAccountForm from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateServiceAccountForm.parse_obj(obj)

        _obj = CreateServiceAccountForm.parse_obj({
