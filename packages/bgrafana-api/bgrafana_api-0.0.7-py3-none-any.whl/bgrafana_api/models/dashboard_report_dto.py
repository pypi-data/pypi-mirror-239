...
class DashboardReportDTO(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DashboardReportDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DashboardReportDTO:
        """Create an instance of DashboardReportDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DashboardReportDTO.parse_obj(obj)

        _obj = DashboardReportDTO.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "uid": obj.get("uid")
        })
