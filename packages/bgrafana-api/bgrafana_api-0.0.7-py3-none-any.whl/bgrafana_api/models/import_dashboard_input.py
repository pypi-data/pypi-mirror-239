...
class ImportDashboardInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ImportDashboardInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ImportDashboardInput:
        """Create an instance of ImportDashboardInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ImportDashboardInput.parse_obj(obj)

        _obj = ImportDashboardInput.parse_obj({
            "name": obj.get("name"),
