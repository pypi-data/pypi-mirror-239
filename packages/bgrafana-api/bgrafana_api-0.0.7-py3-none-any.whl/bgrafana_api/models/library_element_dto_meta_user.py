...
class LibraryElementDTOMetaUser(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LibraryElementDTOMetaUser:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LibraryElementDTOMetaUser:
        """Create an instance of LibraryElementDTOMetaUser from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LibraryElementDTOMetaUser.parse_obj(obj)

        _obj = LibraryElementDTOMetaUser.parse_obj({
