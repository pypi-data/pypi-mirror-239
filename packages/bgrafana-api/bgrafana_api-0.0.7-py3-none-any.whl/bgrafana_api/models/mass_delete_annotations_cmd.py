...
class MassDeleteAnnotationsCmd(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MassDeleteAnnotationsCmd:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MassDeleteAnnotationsCmd:
        """Create an instance of MassDeleteAnnotationsCmd from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MassDeleteAnnotationsCmd.parse_obj(obj)

        _obj = MassDeleteAnnotationsCmd.parse_obj({
