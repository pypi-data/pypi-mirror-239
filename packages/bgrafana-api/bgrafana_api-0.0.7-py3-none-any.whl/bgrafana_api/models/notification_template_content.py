...
class NotificationTemplateContent(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NotificationTemplateContent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NotificationTemplateContent:
        """Create an instance of NotificationTemplateContent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NotificationTemplateContent.parse_obj(obj)

        _obj = NotificationTemplateContent.parse_obj({
