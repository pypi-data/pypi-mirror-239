...
class SaveDashboardCommand(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SaveDashboardCommand:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SaveDashboardCommand:
        """Create an instance of SaveDashboardCommand from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SaveDashboardCommand.parse_obj(obj)

        _obj = SaveDashboardCommand.parse_obj({
