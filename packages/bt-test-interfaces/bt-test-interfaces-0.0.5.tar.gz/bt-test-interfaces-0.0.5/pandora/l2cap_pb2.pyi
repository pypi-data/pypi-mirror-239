...
class ConnectRequest(Message):
  ...
  @property
  def type(self) -> Union[CreditBasedChannelRequest, None, ConnectionOrientedChannelRequest]: ...
...
class ReceiveRequest(Message):
  ...
  @property
  def source(self) -> Union[None, FixedChannel, Channel]: ...
...
class SendRequest(Message):
  ...
  @property
  def sink(self) -> Union[None, FixedChannel, Channel]: ...
