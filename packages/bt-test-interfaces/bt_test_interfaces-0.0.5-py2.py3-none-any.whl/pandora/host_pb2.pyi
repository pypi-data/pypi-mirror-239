...
class DataTypes(Message):
  ...
  @property
  def tx_power_level_oneof(self) -> Union[None, int, bool]: ...
  ...
  @property
  def class_of_device_oneof(self) -> Union[None, int, bool]: ...
  ...
  @property
  def advertising_interval_oneof(self) -> Union[None, int, bool]: ...
...
class ConnectResponse(Message):
  ...
  @property
  def result(self) -> Union[None, empty_pb2.Empty, Connection]: ...
