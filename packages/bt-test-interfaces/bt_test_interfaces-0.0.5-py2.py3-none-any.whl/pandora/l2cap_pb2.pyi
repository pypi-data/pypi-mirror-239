...
class ConnectRequest(Message):
  ...
  @property
  def type(self) -> Union[None, ConnectionOrientedChannelRequest, CreditBasedChannelRequest]: ...
...
class ConnectResponse(Message):
  ...
  @property
  def result(self) -> Union[None, Channel, CommandRejectReason]: ...
...
class DisconnectResponse(Message):
  ...
  @property
  def result(self) -> Union[None, empty_pb2.Empty, CommandRejectReason]: ...
...
class ReceiveRequest(Message):
  ...
  @property
  def source(self) -> Union[None, Channel, FixedChannel]: ...
...
class SendRequest(Message):
  ...
  @property
  def sink(self) -> Union[None, Channel, FixedChannel]: ...
