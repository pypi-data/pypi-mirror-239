...
class RpcEndpoint:
    def __init__(self, rpc, endpoint):
        self.__rpc = rpc
        self.__endpoint = endpoint

    def __getattr__(self, item):
        return functools.partial(getattr(self.__rpc, item), target=self.__endpoint)
...
class Rpc:
    ...
    def endpoint(self, rpc_name):
        return RpcEndpoint(self, rpc_name)
