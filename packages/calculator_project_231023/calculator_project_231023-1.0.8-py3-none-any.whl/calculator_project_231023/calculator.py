...
class Calculator:
    ...
    Methods:
        ...
        add(addend: Union[int, float, Decimal]): Adds the given addend to the current result.
        subtract(subtrahend: Union[int, float, Decimal]): Subtracts the given subtrahend from the
            current result.
        multiply(multiplier: Union[int, float, Decimal]): Multiplies the current result by the
            given multiplier.
        divide(divisor: Union[int, float, Decimal]): Divides the current result by the given
            divisor.
        root(degree: Union[int, float, Decimal]): Calculates the root of the current result with
            the given degree by using the ** exponent operation.
        perform_peration(operator: str, operand: Union[int, float, Decimal]): retrives the
            respective calculation method, runs it, updates the calculator result and prints
            the result.
    """
    ...
    def add(self, addend: Union[int, float, Decimal]) -> None:
        """
        ...
        Raises:
            InvalidOperation: If the operation cannot be carried out with the provided input.
        """
        try:
            self.result += Decimal(addend)
            return
        except InvalidOperation as e:
            print(f"Sorry, this operation is not possible: {e}")
            return

    def subtract(self, subtrahend: Union[int, float, Decimal]) -> None:
        """
    ...
    def multiply(self, multiplier: Union[int, float, Decimal]) -> None:
        """
    ...
    def divide(self, divisor: Union[int, float, Decimal]) -> None:
        """
    ...
    def root(self, degree: Union[int, float, Decimal]) -> None:
        """
    ...
    def perform_operation(self, operator: str, operand: Union[int, float, Decimal]) -> None:
        """
        ...
        try:
            ...
            formated_result = format(self.result, 'f')
            print(f"Result: {formated_result}\n")
            return
        except InvalidOperation:
