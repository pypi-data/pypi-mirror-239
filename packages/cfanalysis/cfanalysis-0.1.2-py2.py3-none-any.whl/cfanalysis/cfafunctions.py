...
def calculate_MAE(model_names, preds, y_test, y_valid):
    ...
    for seed in seed_values:
        ...
        ds_score_combine(generate_models_list(model_names), avg_score_combine_seed, ds_score_combine_seed, ds_scores[seed - 1])
        ds_rank_combine(generate_models_list(model_names), avg_rank_combine_seed, ds_rank_combine_seed, ds_scores[seed - 1])
        ps_score_combine(generate_models_list(model_names), avg_score_combine_seed, ps_score_combine_seed, ps_scores[seed - 1])
        ps_rank_combine(generate_models_list(model_names), avg_rank_combine_seed, ps_rank_combine_seed, ps_scores[seed - 1])
