...
def create_raw_data():
    ...
    kwargs = {
        ...
        # "task_count": scene.task_count,
        # "scout_frame_count": scene.scout_frame_count,
        # "scout_task_count": scene.scout_task_count,
