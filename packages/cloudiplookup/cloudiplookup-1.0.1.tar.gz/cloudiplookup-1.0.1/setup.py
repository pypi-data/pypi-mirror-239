...
setup(
    name='cloudiplookup',
    version='1.0.1',
    description='Cloud IP Lookup is a Pure Python application and library for Python 3 to verify which cloud platform a given IP address belongs to (AWS, Azure, OCI, GCP and DigitalOcean).',
