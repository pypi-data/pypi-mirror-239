...
class Cluster(DistributedCluster, Generic[IsAsynchronous]):
    ...
    def __init__(
        ...
        *,
        ...
        self.worker_cpu = worker_cpu or cast(int | List[int], dask.config.get("coiled.worker.cpu"))
        ...
        self.scheduler_cpu = scheduler_cpu or cast(int | List[int], dask.config.get("coiled.scheduler.cpu"))
        self.scheduler_memory = scheduler_memory or cast(int | List[int], dask.config.get("coiled.scheduler.memory"))
        ...
        self.name = name or cast(str | None, dask.config.get("coiled.name"))
