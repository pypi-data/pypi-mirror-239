...
class BaseCollFilter:
    ...
    def user_cf(self, size_per_user=5, user_similar=None):
        ...
        if user_similar is None:
            user_similar = self.cal_similar(self.user_items, self.item_users, 'ucf')
        return self._do_cf(user_similar, size_per_user, self._do_user_cf, 'ucf')
    ...
    def item_cf(self, size_per_user=5, item_similar=None):
        ...
        if item_similar is None:
            item_similar = self.cal_similar(self.item_users, self.user_items, 'icf')
        return self._do_cf(item_similar, size_per_user, self._do_item_cf, 'icf')
