...
class CollFilter:
    ...
    def user_cf(self, size_per_user=5, user_similar: Mapping[str, Mapping[str, float]] = None) \
    ...
    def item_cf(self, size_per_user=5, item_similar: Mapping[str, Mapping[str, float]] = None) \
            -> Mapping[str, List[Tuple[str, float]]]:
        """
        物品协同过滤
