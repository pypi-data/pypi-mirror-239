...
from compiloor.services.environment.constants import FINDING_RESOLUTION_STATUS_HEADING
...
class Finding:
    ...
    def __init__(self, fragment: str) -> None:
        ...
        self.render_fragment = f'''
            <div id="section-7-[[{self.severity.value}_severity_index]]-{self.id_num}" class="finding">
...
class MarkdownRenderer():
    ...
    def create_markdown(fragment: str, remove_newlines: bool = False) -> str:
        ...
        for heading in range(1, 4): markdown = markdown.replace(f"<h{heading}></h{heading}>", "")
