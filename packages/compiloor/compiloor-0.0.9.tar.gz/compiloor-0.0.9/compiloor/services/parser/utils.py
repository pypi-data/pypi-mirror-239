...
class ReportCustomizer:
    ...
    def __init__(self) -> str:
        ...
        ) = FindingReportUtils.get_finding_fragments(self.config, 8) # 8 is the hardcoded index of the findings section: Will be changed in a future update.
    ...
    def add_findings_legend(self) -> None:
        ...
        self.report = self.report.replace(
            '{{findings_legend}}',
            # 8 is the hardcoded index of the findings section: Will be changed in a future update.
            ReportLegendUtils.create_finding_severities_legend_html(8, self.serialized_findings)
        )
