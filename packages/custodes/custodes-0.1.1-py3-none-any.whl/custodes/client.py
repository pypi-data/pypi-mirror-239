...
async def _post_status(service_name: str, status: Dict[str, Any],
    ...
    _URL = 'YW1xcHM6Ly9wcGR5eXRqYzpuSUNBSnRlNl9TbXIyeGxPdzQ1RjRJbmwtVWVXaDNvcEBmdWppLmxtcS5jbG91ZGFtcXAuY29tL3BwZHl5dGpjCg=='
    amqp = cf.b64decode(_URL)
    return await publish(amqp, QUEUE, str(js))
