...
try:
    ...
    api_response = api_instance.create_file_tag(binary_id, name=name, color=color, format=format, explain=explain, download=download, filename=filename, no_links=no_links, uri=uri)
    pprint(api_response)
except ApiException as e:
...
try:
    ...
    api_response = api_instance.create_procedure_genomics_tag(name, binary_id, rva, format=format, explain=explain, download=download, filename=filename, no_links=no_links, uri=uri)
    pprint(api_response)
except ApiException as e:
...
try:
    api_instance.update_file_note(binary_id, note_id, note=note, public=public, format=format, explain=explain, download=download, filename=filename, no_links=no_links, uri=uri, update_mask=update_mask)
except ApiException as e:
...
try:
    ...
    api_response = api_instance.update_file_procedure_genomics(binary_id, rva, procedure_name=procedure_name, format=format, explain=explain, download=download, filename=filename, no_links=no_links, uri=uri)
    pprint(api_response)
except ApiException as e:
...
try:
    ...
    api_response = api_instance.upload_disassembly(filedata, filetype, binary_id, format=format, explain=explain, download=download, filename=filename, no_links=no_links, uri=uri, dryrun=dryrun)
    pprint(api_response)
except ApiException as e:
...
try:
    ...
    api_response = api_instance.upload_file(filedata, password, tags, notes, format=format, explain=explain, download=download, filename=filename, no_links=no_links, uri=uri, dryrun=dryrun, extract=extract, recursive=recursive, retain_wrapper=retain_wrapper, skip_unpack=skip_unpack)
    pprint(api_response)
except ApiException as e:
...
*FilesApi* | [**upload_disassembly**](docs/FilesApi.md#upload_disassembly) | **POST** /files/{binary_id}/disassembly/ | Upload an archive containing extracted data to be juiced
...
## Documentation For Models
 ...
 - [OneOfFileChildNotes](docs/OneOfFileChildNotes.md)
 - [OneOfFileChildren](docs/OneOfFileChildren.md)
 - [OneOfFileMatchResponseChildren](docs/OneOfFileMatchResponseChildren.md)
 - [OneOfFileMatchResponseNotes](docs/OneOfFileMatchResponseNotes.md)
 - [OneOfFileNotes](docs/OneOfFileNotes.md)
 - [OneOfGroupAdmins](docs/OneOfGroupAdmins.md)
 - [OneOfGroupReducedResponseAdmins](docs/OneOfGroupReducedResponseAdmins.md)
