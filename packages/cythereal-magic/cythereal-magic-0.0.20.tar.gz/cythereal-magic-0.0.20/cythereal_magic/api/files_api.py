...
class FilesApi(object):
    ...
    def create_file_tag_with_http_info(self, binary_id, **kwargs):  # noqa: E501
        ...
        all_params = ['binary_id', 'name', 'color', 'format', 'explain', 'download', 'filename', 'no_links', 'uri']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def create_procedure_genomics_tag_with_http_info(self, name, binary_id, rva, **kwargs):  # noqa: E501
        ...
        all_params = ['name', 'binary_id', 'rva', 'format', 'explain', 'download', 'filename', 'no_links', 'uri']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def update_file_procedure_genomics_with_http_info(self, binary_id, rva, **kwargs):  # noqa: E501
        ...
        all_params = ['binary_id', 'rva', 'procedure_name', 'format', 'explain', 'download', 'filename', 'no_links', 'uri']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def upload_disassembly(self, filedata, filetype, binary_id, **kwargs):  # noqa: E501
        """Upload an archive containing extracted data to be juiced  # noqa: E501

           Upload an archive containing extracted data to be juiced           # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upload_disassembly(filedata, filetype, binary_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str filedata: (required)
        :param str filetype: (required)
        :param str binary_id: (required)
        :param str format: Format of the response from this endpoint
        :param bool explain: Shows the explain for this endpoint
        :param bool download: Determines whether to download the response.(Content-Disposition:\"attachment\" vs \"inline\")
        ...
        kwargs['_return_http_data_only'] = False
        if kwargs.get('async_req'):
            return self.upload_disassembly_with_http_info(filedata, filetype, binary_id, **kwargs)  # noqa: E501
        else:
            (data) = self.upload_disassembly_with_http_info(filedata, filetype, binary_id, **kwargs)  # noqa: E501
            return data

    def upload_disassembly_with_http_info(self, filedata, filetype, binary_id, **kwargs):  # noqa: E501
        """Upload an archive containing extracted data to be juiced  # noqa: E501

           Upload an archive containing extracted data to be juiced           # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upload_disassembly_with_http_info(filedata, filetype, binary_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['filedata', 'filetype', 'binary_id', 'format', 'explain', 'download', 'filename', 'no_links', 'uri', 'dryrun']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('filetype' not in params or
            ...
            raise ValueError("Missing the required parameter `filetype` when calling `upload_disassembly`")  # noqa: E501
        # verify the required parameter 'binary_id' is set
        if ('binary_id' not in params or
                params['binary_id'] is None):
            raise ValueError("Missing the required parameter `binary_id` when calling `upload_disassembly`")  # noqa: E501
        ...
        if 'filetype' in params:
            form_params.append(('filetype', params['filetype']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/files/{binary_id}/disassembly/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def upload_file_with_http_info(self, filedata, password, tags, notes, **kwargs):  # noqa: E501
        ...
        all_params = ['filedata', 'password', 'tags', 'notes', 'format', 'explain', 'download', 'filename', 'no_links', 'uri', 'dryrun', 'extract', 'recursive', 'retain_wrapper', 'skip_unpack']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
