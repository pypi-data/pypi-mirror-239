...
class User(object):
    ...
    def __init__(self, id=None, email=None, username=None, first_name='', last_name='', name=None, is_public=False, membership_level=1, membership_name='Free', membership_enddate=None, _self=None, membership=None):  # noqa: E501
