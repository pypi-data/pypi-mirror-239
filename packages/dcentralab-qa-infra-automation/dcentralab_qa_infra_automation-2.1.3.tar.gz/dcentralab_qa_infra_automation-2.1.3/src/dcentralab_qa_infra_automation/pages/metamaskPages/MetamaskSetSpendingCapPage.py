...
class MetamaskSetSpendingCapPage(BasePage):
    ...
    def is_page_loaded(self):
        ...
        if "approve" in url:
            return self.is_element_exist("METAMASK_TOKEN_APPROVAL_CONTAINER",
                                         METAMASK_TOKEN_APPROVAL_CONTAINER) and self.is_element_exist(
                "METAMASK_TOKEN_APPROVAL_SPENDING_CAP_CONTAINER",
                METAMASK_TOKEN_APPROVAL_SPENDING_CAP_CONTAINER) and self.is_element_exist(
                "METAMASK_TOKEN_APPROVAL_SPENDING_CAP_INPUT",
                METAMASK_TOKEN_APPROVAL_SPENDING_CAP_INPUT) and self.is_element_exist(
                "METAMASK_TOKEN_APPROVAL_SPENDING_CAP_MAX_BTN", METAMASK_TOKEN_APPROVAL_SPENDING_CAP_MAX_BTN)
