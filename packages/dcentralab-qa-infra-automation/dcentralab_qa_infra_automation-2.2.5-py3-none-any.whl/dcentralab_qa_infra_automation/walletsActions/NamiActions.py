...
class NamiActions(WalletsActionsInterface):
    ...
    def import_wallet(self):
        ...
        self.nami_import_seed_phrase_page.insert_word_seed_phrase(seed_phrase_list = pytest.wallets.get("cardano"))
        ...
        # Insert account name
        self.nami_create_account_page.insert_account_name(account_name=pytest.wallets_data.get("cardano").get("account_name"))
        ...
        # Confirm password
        self.nami_create_account_page.insert_confirm_password(pytest.wallets_data.get("cardano").get("account_password"))
