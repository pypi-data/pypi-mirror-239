...
"""page locators"""
NAMI_IMPORT_WALLET_CONTAINER_TITLE = (By.XPATH, "//*[contains(@class,'chakra-text css-yefpd7') and contains(text(),'Import')]")
NAMI_SEED_PHRASE_INPUTS = (By.CLASS_NAME, "//*[contains(@class, 'chakra-input')]")
NAMI_IMPORT_WALLET_NEXT_BUTTON = (By.XPATH, "//*[contains(text(), 'Next')]")
...
class NamiImportSeedPhrasePage(BasePage):
    ...
    def is_page_loaded(self):
        ...
        if "import" in url and self.is_element_exist("NAMI_IMPORT_WALLET_CONTAINER_TITLE", NAMI_IMPORT_WALLET_CONTAINER_TITLE):
    ...
    def insert_word_seed_phrase(self, seed_phrase_list):
        ...
        for index in range(0,len(seed_phrase_list)):
            self.enter_text_on_specific_list_item(f"SEED_PHRASE_WORDS_{index+1}", NAMI_SEED_PHRASE_INPUTS, index,
                                                  pytest.wallets_data.get("cardano").get(f"Seed_Phrase_{index+1}"))
    ...
    def click_on_next_button(self):
        ...
        """
        self.click("NEXT_BTN", NAMI_IMPORT_WALLET_NEXT_BUTTON)
