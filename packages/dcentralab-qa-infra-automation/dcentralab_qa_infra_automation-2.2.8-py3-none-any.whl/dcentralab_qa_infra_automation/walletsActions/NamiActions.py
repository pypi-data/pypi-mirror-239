...
class NamiActions(WalletsActionsInterface):
    ...
    def import_wallet(self):
        ...
        self.nami_welcome_page.choose_word_seed_phrase(len(pytest.wallets_data.get("cardano")))
        ...
        self.nami_import_seed_phrase_page.insert_word_seed_phrase(seed_phrase_list=pytest.wallets_data.get("cardano"))
