...
class StoreMixin:
    ...
    def get_stores(self, keyword: str, page_no: int, page_size: int = 20):
        ...
        response = requests.post('http://im.diningcode.com/API/isearch/', headers=headers, data=data, allow_redirects=False)
