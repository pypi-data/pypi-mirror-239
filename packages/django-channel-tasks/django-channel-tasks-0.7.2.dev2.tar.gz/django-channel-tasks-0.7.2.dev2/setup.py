...
setuptools.setup(
    ...
    package_data={'django_tasks': ['templates/*.html', 'settings/channel-task-defaults.ini']},
    data_files=[('./channel-tasks-docker', ['docker-compose.yml',
                ...
                ('./channel-tasks-unit', ['services/nginx-unit/application.template.json',
                                          ...
                                          'services/nginx-unit/app-route.template.json',
                                          'services/nginx-unit/static-route.template.json']),
