...
# xls_format = []
# for c,col in zip(ALPHA,df.columns):
#     if col=='ean': xls_format.append({'col':c, 'name':'EAN', 'len':15})
#     elif col=='sku': xls_format.append({'col':c, 'name':'SKU', 'len':15})
#     elif col=='name': xls_format.append({'col':c, 'name':'Product', 'len':60})
#     elif col=='min': xls_format.append({'col':c, 'name':'MIN', 'len':12, 'frmt':'C'})
#     elif col=='max': xls_format.append({'col':c, 'name':'MAX', 'len':12, 'frmt':'C'})
#     else: xls_format.append({'col':c, 'name':col.capitalize(), 'len':12, 'frmt':'C'})
