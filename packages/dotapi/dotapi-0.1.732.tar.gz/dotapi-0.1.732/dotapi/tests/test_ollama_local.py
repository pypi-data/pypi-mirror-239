...
#     messages = [{ "content": user_message,"role": "user"}]
#     try:
#         response = await anyllm.acompletion(
#             model="ollama/llama2", 
#             messages=messages, 
#             api_base="http://localhost:11434", 
#             stream=True
...
#     params = {
#         "messages": prepare_messages_for_chat("What is anyllm? tell me 10 things about it who is sihaan.write an essay"),
#         "api_base": "http://localhost:11434",
#         "model": "ollama/llama2",
#         "stream": True,
#     }
#     response = await anyllm.acompletion(**params)
#     return response
