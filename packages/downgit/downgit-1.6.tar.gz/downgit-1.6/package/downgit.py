...
def get_content(url, ignore_files):
    try:
    ...
    try:
        ...
        match command:
            ...
            case "help":
                ...
                print("help")
            case _:
                print("Please provide a valid command, type 'downgit help' for more info")
    except IndexError:
        print("Please provide a command, type 'downgit help' for more info")
