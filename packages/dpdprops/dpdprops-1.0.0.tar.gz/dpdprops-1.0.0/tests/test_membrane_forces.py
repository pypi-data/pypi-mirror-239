...
from dpdprops import (KantorParams,
                      ...
                      compute_vertex_mean_curvatures,
...
class TestMembraneForces(unittest.TestCase):
    ...
    def test_vertex_mean_curvatures(self):
        ...
        curv = compute_vertex_mean_curvatures(vertices=mesh.vertices,
                                              faces=mesh.faces,
                                              dihedrals=dihedrals)

        C = np.mean(curv)
        self.assertAlmostEqual(C, 2/R, places=1)
