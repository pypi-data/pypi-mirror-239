...
def create_folder_structure(parent_folder, *args):
    ...
    # Specify the relative path to the source file
    source_file_path = os.path.join(module_dir, 'file_contents', 'router.py')
    validation_path = os.path.join('fastapi_prime', 'src', 'fastapi_prime','file_contents','validations.py')
    router_path = os.path.join(module_dir, 'file_contents', 'router.py')
    main_path = os.path.join('fastapi_prime', 'src', 'fastapi_prime','file_contents','main.py')
    config_path = os.path.join('fastapi_prime', 'src', 'fastapi_prime','file_contents','config.py')
