...
def generate_labels(filenames, model_name='automatic', device = 'cpu', batch_size=8, max_new_tokens=20):
    '''
    ...
    # generate captions
    try:
        captioner = pipeline("image-to-text", model=model, device=device, max_new_tokens=max_new_tokens)
