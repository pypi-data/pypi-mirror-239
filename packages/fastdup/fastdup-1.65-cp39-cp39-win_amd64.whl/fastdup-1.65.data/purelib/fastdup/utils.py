...
def load_filenames(work_dir, kwargs):
    ...
    assert filenames is not None and len(filenames), "Empty dataframe found " + local_filenames
    ...
    assert filenames['filename'].values[0] is not None, "Failed to find filenames in col"
    return filenames
