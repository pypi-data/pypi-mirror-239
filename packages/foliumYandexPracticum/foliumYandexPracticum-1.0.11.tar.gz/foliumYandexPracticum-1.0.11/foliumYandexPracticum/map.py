...
class _CustomIcon(Icon):
    ...
    def __init__(self, 
                 icon_image='https://code.s3.yandex.net/data_faculty/folium/marker.svg?etag=2e5c913ee0aa226938c4cee5c0e01300', 
                 icon_size=(30, 30), icon_anchor=None,
