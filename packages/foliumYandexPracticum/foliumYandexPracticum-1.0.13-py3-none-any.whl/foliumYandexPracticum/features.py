...
from foliumYandexPracticum.map import (FeatureGroup, Icon, Layer, Marker, Tooltip)
...
from foliumYandexPracticum.vector_layers import Circle, CircleMarker, PolyLine, path_options
