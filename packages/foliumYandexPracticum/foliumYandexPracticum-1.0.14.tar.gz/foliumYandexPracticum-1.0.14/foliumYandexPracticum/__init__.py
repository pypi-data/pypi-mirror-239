...
from foliumYandexPracticum.features import (
    Choropleth,
    ClickForMarker,
    ColorLine,
    CustomIcon,
...
from foliumYandexPracticum.folium import Map
from foliumYandexPracticum.map import (
    FeatureGroup,
    FitBounds,
    Icon,
    LayerControl,
...
from foliumYandexPracticum.raster_layers import TileLayer, WmsTileLayer
from foliumYandexPracticum.vector_layers import Circle, CircleMarker, PolyLine, Polygon, Rectangle
