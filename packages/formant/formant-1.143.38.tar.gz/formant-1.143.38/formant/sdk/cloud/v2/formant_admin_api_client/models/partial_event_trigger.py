...
class PartialEventTrigger:
    ...
    Attributes:
        ...
        condition (Union['BatteryEventTriggerCondition', 'BitsetEventTriggerCondition', 'JsonEventTriggerCondition',
        ...
        exit_condition (Union['BatteryEventTriggerCondition', 'BitsetEventTriggerCondition',
            'JsonEventTriggerCondition', 'NumericSetEventTriggerCondition', 'PresenceEventTriggerCondition',
            'RegexEventTriggerCondition', 'ThresholdEventTriggerCondition', None, Unset]):
