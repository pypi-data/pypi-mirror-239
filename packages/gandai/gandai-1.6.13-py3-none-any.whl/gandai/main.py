...
def enrich_with_gpt(domain: str) -> None:
    ...
    messages = [
        ...
        {
            "role": "user",
            "content": f"You are to create a asdict(Review) {REVIEW}, fill it out and return it to me as valid JSON that can be passed to eval().",
        },
    ]
