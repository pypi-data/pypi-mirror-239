...
# Agents Enum
character_path = os.path.join(os.path.dirname(__file__), "characters")
        ...
        enum_data.update(
            {
                name.upper(): {
                    "kind": kind.upper(),
                    "lang": lang.upper(),
                    "path": os.path.join(character_path, name, "info.json"),
                }
            }
        )
Agent_Type = enum.Enum("Agent_Type", enum_data)
