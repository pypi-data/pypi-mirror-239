    ...
    def get_pixels(
        ...
        *,
        ...
        Args:
            ...
            bbox_crs: the spatial reference of the bounding bbox, as a string. May be EPSG:<code>, WKT, Proj4, ProjJSON,
                etc.
            ...
            output_nodata (deprecated): what value should be set as the nodata value in the resulting dataset. Only
                meaningful for tiff outputs.
            bbox_srs (deprecated): the spatial reference of the bounding bbox, as a string. May be EPSG:<code>, WKT,
                Proj4, ProjJSON, etc.
