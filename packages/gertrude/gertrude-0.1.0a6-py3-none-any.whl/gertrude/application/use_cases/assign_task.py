...
from gertrude.domain.task_management.value_objects import ProjectId, TaskId
...
class Interactor:
    ...
    def execute(self, request: Request) -> None:
        ...
        if not request.project_id:
            return self.presenter.missing_project_id()
        ...
        try:
            ...
            return self.presenter.incorrect_project_id()
