        ...
        for i,test_start in enumerate(test_starts):
            if i == 0 :
                ...
                if len(test) < increment_size:
                    ...
                    yield (
                        indices[:test_start+1],
                        indices[test_start + gap : test_start  + increment_size + gap + 1],
                    )
            else:
                test = indices[test_start + gap + intra_gap: test_start + increment_size + intra_gap + gap ]
                if len(test) < increment_size:
                    ...
                    yield (
                        indices[i*increment_size:test_start+ intra_gap+1], #train
                        indices[test_start + gap + intra_gap: test_start + intra_gap + increment_size + gap +1], #test
                    )
