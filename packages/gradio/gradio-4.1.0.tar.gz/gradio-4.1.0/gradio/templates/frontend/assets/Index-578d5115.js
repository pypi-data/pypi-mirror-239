...
import { n as normalise_file } from './index-b5b16a51.js';
/* empty css                                                     */import { M as ModifyUpload } from './ModifyUpload-6f4d1a92.js';
...
function create_if_block_3(ctx) {
	...
	return {
		c() {
			...
			if (!src_url_equal(img.src, img_src_value = /*_value*/ ctx[12][/*selected_index*/ ctx[0]].image.path)) attr(img, "src", img_src_value);
		...
		p(ctx, dirty) {
			...
			if (!current || dirty[0] & /*_value, selected_index*/ 4097 && !src_url_equal(img.src, img_src_value = /*_value*/ ctx[12][/*selected_index*/ ctx[0]].image.path)) {
...
function create_each_block_1(ctx) {
	...
	return {
		c() {
			...
			img = element("img");
			t = space$1();
			if (!src_url_equal(img.src, img_src_value = /*image*/ ctx[42].image.path)) attr(img, "src", img_src_value);
		...
		p(new_ctx, dirty) {
			...
			if (dirty[0] & /*_value*/ 4096 && !src_url_equal(img.src, img_src_value = /*image*/ ctx[42].image.path)) {
				attr(img, "src", img_src_value);
			}
...
//# sourceMappingURL=Index-578d5115.js.map
