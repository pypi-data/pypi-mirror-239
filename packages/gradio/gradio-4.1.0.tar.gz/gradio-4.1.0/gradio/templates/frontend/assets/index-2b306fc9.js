import { U as Upload$1 } from './Upload-8319436b.js';
import { U as Undo, M as ModifyUpload } from './ModifyUpload-6f4d1a92.js';
import { B as Block } from './Button-723db480.js';
import { B as BlockLabel } from './BlockLabel-7be36365.js';
import { S as Static } from './Index-f62c49f9.js';
import { a as Upload, U as UploadText } from './UploadText-3896a06d.js';
import { W as Webcam } from './ImageUploader-67d8fb51.js';
/* empty css                                                */import { l as loadFfmpeg, t as trimVideo, V as Video$2, p as prettyBytes, a as playable } from './Example-e48055ad.js';
export { E as BaseExample, b as loaded } from './Example-e48055ad.js';
import { T as Trim, P as Pause, a as Play } from './Trim-7bd312df.js';
import { p as prepare_files, u as upload, n as normalise_file } from './index-b5b16a51.js';
import { I as IconButton } from './IconButton-34156fe0.js';
import { E as Empty } from './Empty-ee9cf9c4.js';
import { S as ShareButton } from './ShareButton-49d16ef8.js';
...
import './DropdownArrow-efc856ea.js';
import './file-url-fc87e7e1.js';
...
function create_else_block$5(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen$3(button0, "mousedown", /*mousedown_handler*/ ctx[10]),
					listen$3(button0, "blur", /*stopDragging*/ ctx[5]),
					listen$3(button0, "keydown", /*keydown_handler*/ ctx[11]),
					listen$3(button1, "mousedown", /*mousedown_handler_1*/ ctx[12]),
					listen$3(button1, "blur", /*stopDragging*/ ctx[5]),
					listen$3(button1, "keydown", /*keydown_handler_1*/ ctx[13])
				];
...
function create_if_block_2$3(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = listen$2(button, "click", /*click_handler*/ ctx[18]);
				mounted = true;
			}
		},
		p(ctx, dirty) {
...
function create_else_block$4(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen$2(button0, "click", /*click_handler_1*/ ctx[19]),
...
function create_fragment$3(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen$1(span0, "click", /*play_pause*/ ctx[13]),
					listen$1(span0, "keydown", /*play_pause*/ ctx[13]),
					listen$1(progress, "mousemove", /*handleMove*/ ctx[12]),
					listen$1(progress, "touchmove", prevent_default(/*handleMove*/ ctx[12])),
					listen$1(progress, "click", stop_propagation(prevent_default(/*handle_click*/ ctx[14]))),
					listen$1(div1, "click", /*open_full_screen*/ ctx[17]),
					listen$1(div1, "keypress", /*open_full_screen*/ ctx[17])
				];
...
// (39:0) {#if value === null || value.url === undefined}
...
function create_if_block_5(ctx) {
	...
	return {
		c() {
			...
			div1 = element$1("div");
			t2 = text(t2_value);
			attr$1(div0, "class", "file-name svelte-1ipnm0o");
			attr$1(div1, "class", "file-size svelte-1ipnm0o");
		},
		m(target, anchor) {
...
function create_if_block_2$1(ctx) {
	...
	upload = new Upload$1({ props: upload_props });
...
// (41:2) <Upload    bind:dragging    filetype="video/x-m4v,video/*"    on:load={handle_load}    on:error={({ detail }) => dispatch("error", detail)}    {root}   >
...
function create_if_block$2(ctx) {
	...
	return {
		c() {
			...
			create_component$2(uploadicon.$$.fragment);
			t = space$2();
			button1 = element$1("button");
			create_component$2(video.$$.fragment);
			attr$1(button0, "class", "icon svelte-1ipnm0o");
			attr$1(button0, "aria-label", "Upload video");
			attr$1(button1, "class", "icon svelte-1ipnm0o");
			attr$1(button1, "aria-label", "Record video");
			attr$1(span, "class", "source-selection svelte-1ipnm0o");
		},
		m(target, anchor) {
			insert$2(target, span, anchor);
			append$1(span, button0);
			mount_component$2(uploadicon, button0, null);
			append$1(span, t);
			append$1(span, button1);
			mount_component$2(video, button1, null);
			current = true;
		...
		i(local) {
			if (current) return;
			transition_in$2(uploadicon.$$.fragment, local);
			transition_in$2(video.$$.fragment, local);
			current = true;
		},
		o(local) {
			transition_out$2(uploadicon.$$.fragment, local);
			transition_out$2(video.$$.fragment, local);
			current = false;
		},
		d(detaching) {
			if (detaching) {
			...
			destroy_component$2(uploadicon);
			destroy_component$2(video);
			mounted = false;
			run_all(dispose);
		}
	};
...
function create_fragment$2(ctx) {
	...
	current_block_type_index = select_block_type(ctx);
	if_block0 = if_blocks[current_block_type_index] = if_block_creators[current_block_type_index](ctx);
	let if_block1 = /*sources*/ ctx[3].length > 1 && create_if_block$2(ctx);
	...
	return {
		...
		m(target, anchor) {
			...
			insert$2(target, t1, anchor);
			if (if_block1) if_block1.m(target, anchor);
			insert$2(target, if_block1_anchor, anchor);
			current = true;
		},
		p(ctx, [dirty]) {
...
function instance$2($$self, $$props, $$invalidate) {
	...
	const click_handler_1 = () => {
		handle_clear();
		$$invalidate(1, active_source = "webcam");
	};
...
//# sourceMappingURL=index-2b306fc9.js.map
