...
class Grid(AbstractGrid, _ABC):
    ...
    def __init__(
        ...
        """
        if dimensions is not None and (dimensions[0] * dimensions[1] > 1000000) and not self._size_warning(dimensions):
            return
