...
class MetadataService:
    def __init__(
        ...
        self._project = project if project else os.getenv("project")
        self._region = region if region else os.getenv("region")
        self._service_account = service_account if service_account else os.getenv("service_account")
        self._public_url = public_url if public_url else os.getenv("public_url")
        self.headers = {
