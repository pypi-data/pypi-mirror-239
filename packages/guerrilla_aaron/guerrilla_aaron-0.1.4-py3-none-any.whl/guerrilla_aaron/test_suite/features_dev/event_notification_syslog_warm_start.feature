Feature: [Event Notification - Syslog]
	...
	@event-notification @sanity @self_testing @edrg9010_v2 @edrg9010_v3 @edr8010_v3 @tn4900_v3
	Scenario: Warm Start
		...
		* run syslog service on "HOST_A"
		...
		Then "DUT" record event log "Warm Start System Restart"
		And "HOST_A" receive syslog "Warm Start System Restart"
