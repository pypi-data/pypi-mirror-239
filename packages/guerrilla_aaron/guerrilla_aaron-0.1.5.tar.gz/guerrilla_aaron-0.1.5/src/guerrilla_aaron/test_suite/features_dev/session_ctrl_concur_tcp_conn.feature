...
HOST_B(receiver) IP ADDR: 192.168.127.93
    ...
    Scenario: TCP Traffic Number Can Be Limited By concurrent TCP Connection
        ...
        *     add static route for "HOST_B" routing to "HOST_A"
        ...
        ## Concurrent TCP connection is calculated based on the number of received SYN packets.
        When  send "4" TCP syn from "HOST_A" to "HOST_B" within 1 sec
