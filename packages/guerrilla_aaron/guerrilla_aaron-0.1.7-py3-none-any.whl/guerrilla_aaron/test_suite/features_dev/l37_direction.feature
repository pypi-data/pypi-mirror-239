...
HOST_B(receiver) IP ADDR: 192.168.127.93
    ...
    Scenario Outline:  Deny TCP from <incoming interface> to <outgoing interface>
        ...
        *     set a firewall rule on "DUT" to deny TCP and "IP and Port Filtering" from <incoming interface> ("<sender>") to <outgoing interface> ("<receiver>") and enable logging flash
        ...
        @l37 @edrg9010_v2 @edrg9010_v3 @edr8010_v3 @tn4900_v3
        Examples:
            | incoming interface | outgoing interface | sender | receiver |
            | WAN                | LAN                | HOST_A | HOST_B   |

        @l37 @sanity @edrg9010_v3 @edr8010_v3 @tn4900_v3
        Examples:
            | incoming interface | outgoing interface | sender | receiver |
            | WAN                | LAN                | HOST_A | HOST_B   |
            | LAN                | WAN                | HOST_B | HOST_A   |
            | BRG                | BRG                | HOST_A | HOST_B   |
