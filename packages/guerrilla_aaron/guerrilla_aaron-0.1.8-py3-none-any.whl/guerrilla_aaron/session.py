...
from guerrilla_aaron.mdc import *
from pexpect import pxssh, TIMEOUT, EOF
from guerrilla_aaron.utils.debug_output import create_debug_output
from guerrilla_aaron.mdc.router.cli.common_func import telnet_login
...
class TelnetSession:
    ...
    def open(self) -> bool:
        ...
        """
        self._session = pexpect.popen_spawn(
