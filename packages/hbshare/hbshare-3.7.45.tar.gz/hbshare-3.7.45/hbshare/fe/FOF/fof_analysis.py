...
class FOF_analysis:
    ...
    def brinson_wise_analysis(fund_attribution,dir,howbuy_index_ret
        ...
        if(stock_bmk_w is None):
            ...
            stock_sharp= \
                stock_ret/\
                (howbuy_index_ret['HB0011'].pct_change().std()*np.sqrt(52))
        ...
        mu_index_ret = pd.merge(mu_index_ret[['399311', '国证大盘', '国证中盘', '国证小盘', '国证成长', '国证价值', '881001', '公募偏股',
       'CBA00301', 'CI0077']], howbuy_index_ret[['HB0011', 'CTA', '主观多头', '量化多头']],
                                how='left', on='jyrq')
        ...
        index_std = mu_index_ret[['公募偏股',
                                  'CBA00301', 'HB0011', 'CTA', '主观多头', '量化多头', '1000指数增强', '300指数增强',
       ...
       '主观多头', '量化多头','1000指数增强', '300指数增强', '500指数增强',]:
        ...
        for col in ['CTA','主观多头','量化多头','公募偏股','HB0011','CBA00301'
        ...
        index_ret_monthly=mu_index_ret[['jyrq','CTA','主观多头','量化多头'
            ,'公募偏股','HB0011','CBA00301','1000指数增强', '300指数增强', '500指数增强']].rename(columns={'jyrq':'date'})
        ...
        total_extra_ret = (equit_att[['进攻性资产_x', 'CTA_x', '稳健性资产_x']].fillna(0).values * equit_att[
            ['进攻性资产_y', 'CTA_y', '稳健性资产_y']].fillna(0).values \
                           - equit_att[['HB0011', 'CTA', 'CBA00301']].fillna(0).values * equit_att[
        ...
        allocation_extraret = ((equit_att[['进攻性资产_y', 'CTA_y', '稳健性资产_y']].fillna(0).values - \
                                equit_att[['进攻性资产bmk_w', 'CTAbmk_w', '稳健性资产bmk_w']].values) * equit_att[
                                   ['HB0011', 'CTA', 'CBA00301']].fillna(0).values).sum(axis=1)
        selection_extraret = pd.DataFrame(data=(equit_att[['进攻性资产bmk_w', 'CTAbmk_w', '稳健性资产bmk_w']].values * (
                    ...
                    equit_att[['HB0011', 'CTA', 'CBA00301']].fillna(0).values))).fillna(0).sum(axis=1)
    ...
    def calculate_holding_time(inputdf):
        ...
        for asset in yjcl_weight_his['yjcl'].unique():
            ...
            for date in yjcl_weight_his['date'].unique():
    ...
    def holding_analysis(self,dir,start_date=None):
        ...
        self.brinson_wise_analysis(fund_attribution,dir,howbuy_index_ret
                              , mu_index_ret, index_enhance_index,stock_bmk_w=1/3,bond_bmk_w=1/3,CTA_bmk_w=1/3)
...
if __name__ == '__main__':
    ...
    for product in ['新方程对冲精选H1号基金']:
        ...
        #                         ,start_date='20190506',product=product)
