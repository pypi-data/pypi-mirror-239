...
if __name__ == '__main__':
    ...
    groupdf, factrodf = single_factor_ic(raw_df, factor_name='info_ratio', fre=fre, pool_size=30,
                                             fund_flag=True)
    ...
    #
    # groupdf, factrodf = single_factor_ic(raw_df, factor_name='info_ratio', fre=fre, pool_size=10,
    #                                          fund_flag=True)
    #
