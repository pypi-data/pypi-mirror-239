...
class General_holding:
    ...
    def key_holding_expantation(self,jjdm_list,asofdate,last_date,
        ...
        pd.concat(outputdf,axis=0).fillna(0).to_excel('补全持仓数据_{}.xlsx'.format(asofdate))

    @staticmethod
    def save_quarter_data_2_db(path):
...
if __name__ == '__main__':
    ...
    gh=General_holding()
    gh.save_quarter_data_2_db( r"E:\GitFolder\docs\公募基金行业动态模拟\持仓数据补全\年报半年报补全\\")
    # asofdate='20221230'
    #gh.key_holding_expantation(util.get_stock_funds_pool(str(2023)+'0331',time_length=0.5), str(2023)+'0331', str(2022)+'1231', str(2023)+'0301', str(2023)+'0430')
    # for i in range(8,9):
        # print(i)
    ...
    # gh.save_style_exp2db(jjdm_list,start_date='20'
