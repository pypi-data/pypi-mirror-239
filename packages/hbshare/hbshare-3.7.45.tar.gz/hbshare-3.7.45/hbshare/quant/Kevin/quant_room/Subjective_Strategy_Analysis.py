...
class HoldingAnalysor:
    ...
    def save_construct_result2loacl(self,gsjc,jjjc,is_tl_show=False,merged_note=None):
        ...
        authority=pd.read_excel(r"C:\Users\xuhuai.zhe\Documents\WXWork\1688858146292774\WeDrive\好买财富\【每月更新】估值表加代码、查询最新日期+风格\私募估值表跟踪.xlsx")[['研究员','管理人']]
...
def update_the_entire_prv_holding_data():
    ...
    # #saved the raw data into local DB 'SK8618'
    jjdm_info=\
        pd.read_excel(r"C:\Users\xuhuai.zhe\Documents\WXWork\1688858146292774\WeDrive\好买财富\【每月更新】估值表加代码、查询最新日期+风格\私募估值表跟踪.xlsx")
    jjdm_list=jjdm_info['基金代码'].tolist()

    #jjdm_list=['P11954']

    gzb_date_list=getZlJjdmGzrq("2010-01-01 00:00:00")
...
def get_the_prv_analysis_result():
    ...
    from_local_db=True #瀚川投资 仁桥资产 石锋资产
    for glr in jjdm_info['管理人'].unique().tolist():
    ...
    jjdm_info.to_excel(r"C:\Users\xuhuai.zhe\Documents\WXWork\1688858146292774\WeDrive\好买财富\【每月更新】估值表加代码、查询最新日期+风格\私募估值表跟踪.xlsx"
                       ,index=False)
