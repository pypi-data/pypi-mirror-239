...
def estimate_bsz_start_4gpus(type,scale,max_bsz_estimator):
    prune_percent = 0.4
    if type == 'full':
        baselines = [[1,1,4,{'fsdp':0}],[1,4,1,{'fsdp':0}],[4,1,1,{}],[1,1,4,{'fsdp':1}]]
    elif type == 'dp+tp':
        baselines = [[1,1,4,{'fsdp':0}],[1,4,1,{'fsdp':0}]]
    elif type == 'dp+pp':
        baselines = [[1,1,4,{'fsdp':0}],[4,1,1,{}]]
        prune_percent = 0
