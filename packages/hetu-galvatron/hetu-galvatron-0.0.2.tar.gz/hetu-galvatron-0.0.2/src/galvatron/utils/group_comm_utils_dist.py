import torch
from .allgather_utils import gather_from_group, split_to_group
...
def gen_groups_dist(all_tp_sizes, pp_size, tp_consecutive_flags, show_rank = -1, world_ranks = None):
    world_ranks = sort_ranks(world_ranks)
