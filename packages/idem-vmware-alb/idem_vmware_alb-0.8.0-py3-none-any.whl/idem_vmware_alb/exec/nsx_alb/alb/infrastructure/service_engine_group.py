"""Exec module for managing Alb Infrastructure Service Engine Groups. """
...
async def get(
    ...
    Args:
        resource_id(str):
            Alb.infrastructure.service_engine_group unique ID.
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            unmanaged_resource:
              exec.run:
                - path: nsx_alb.alb.infrastructure.service_engine_group.get
                - kwargs:
                  resource_id: value
        ...
        .. code-block:: bash
            ...
            idem exec nsx_alb.alb.infrastructure.service_engine_group.get resource_id=value
    """
...
async def list_(hub, ctx) -> Dict[str, Any]:
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            unmanaged_resources:
              exec.run:
                - path: nsx_alb.alb.infrastructure.service_engine_group.list
                - kwargs:
        ...
        .. code-block:: bash
            ...
            idem exec nsx_alb.alb.infrastructure.service_engine_group.list
...
async def create(
    ...
    Examples:
        ...
        .. code-block:: bash
            ...
            idem exec nsx_alb.alb.infrastructure.service_engine_group.create x_avi_version=value
    """
...
async def update(
    ...
    Examples:
        ...
        .. code-block:: bash
            ...
            idem exec nsx_alb.alb.infrastructure.service_engine_group.update resource_id=value
    """
...
async def delete(hub, ctx, resource_id: str, name: str = None) -> Dict[str, Any]:
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_absent:
              nsx_alb.alb.infrastructure.service_engine_group.absent:
                - resource_id: value
        ...
        .. code-block:: bash
            ...
            idem exec nsx_alb.alb.infrastructure.service_engine_group.delete resource_id=value
    """
