"""Exec module for managing Alb Infrastructure Clouds. """
...
async def get(
    ...
    Args:
        resource_id(str):
            Alb.infrastructure.cloud unique ID.
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            unmanaged_resource:
              exec.run:
                - path: nsx_alb.alb.infrastructure.cloud.get
                - kwargs:
                  resource_id: value
        ...
        .. code-block:: bash
            ...
            idem exec nsx_alb.alb.infrastructure.cloud.get resource_id=value
    """
...
async def list_(hub, ctx) -> Dict[str, Any]:
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            unmanaged_resources:
              exec.run:
                - path: nsx_alb.alb.infrastructure.cloud.list
                - kwargs:
        ...
        .. code-block:: bash
            ...
            idem exec nsx_alb.alb.infrastructure.cloud.list
...
async def create(
    ...
    Examples:
        ...
        .. code-block:: bash
            ...
            idem exec nsx_alb.alb.infrastructure.cloud.create vtype=value
    """
...
async def update(
    ...
    Examples:
        ...
        .. code-block:: bash
            ...
            idem exec nsx_alb.alb.infrastructure.cloud.update resource_id=value, vtype=value
    """
...
async def delete(hub, ctx, resource_id: str, name: str = None) -> Dict[str, Any]:
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_absent:
              nsx_alb.alb.infrastructure.cloud.absent:
                - resource_id: value
        ...
        .. code-block:: bash
            ...
            idem exec nsx_alb.alb.infrastructure.cloud.delete resource_id=value
    """
