"""Exec module for managing Alb Profiles Health Monitors. """
...
async def get(
    ...
    Args:
        resource_id(str):
            Alb.profiles.health_monitor unique ID.
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            unmanaged_resource:
              exec.run:
                - path: nsx_alb.alb.profiles.health_monitor.get
                - kwargs:
                  resource_id: value
        ...
        .. code-block:: bash
            ...
            idem exec nsx_alb.alb.profiles.health_monitor.get resource_id=value
    """
...
async def list_(hub, ctx) -> Dict[str, Any]:
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            unmanaged_resources:
              exec.run:
                - path: nsx_alb.alb.profiles.health_monitor.list
                - kwargs:
        ...
        .. code-block:: bash
            ...
            idem exec nsx_alb.alb.profiles.health_monitor.list
...
async def create(
    ...
    Examples:
        ...
        .. code-block:: bash
            ...
            idem exec nsx_alb.alb.profiles.health_monitor.create type=value
    """
...
async def update(
    ...
    Examples:
        ...
        .. code-block:: bash
            ...
            idem exec nsx_alb.alb.profiles.health_monitor.update resource_id=value, type=value
    """
...
async def delete(hub, ctx, resource_id: str, name: str = None) -> Dict[str, Any]:
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_absent:
              nsx_alb.alb.profiles.health_monitor.absent:
                - resource_id: value
        ...
        .. code-block:: bash
            ...
            idem exec nsx_alb.alb.profiles.health_monitor.delete resource_id=value
    """
