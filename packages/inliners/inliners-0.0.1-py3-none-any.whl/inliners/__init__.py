...
def main(args=None):
    parser = _aap.parser.by_object(parse, prog="inliners")
    ns = parser.parse_args(args)
    funcInput = _aap.process_namespace.by_object(parse, namespace=ns)
    try:
        ans = _aap.execution.by_object(parse, funcInput=funcInput)
