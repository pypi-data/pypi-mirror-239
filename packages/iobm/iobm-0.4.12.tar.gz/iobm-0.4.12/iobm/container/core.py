    ...
    def train(self, num_epochs):
        ...
        for epoch in range(num_epochs):
            ...
            for index, batch in enumerate(progress_bar):
                ...
                print(f'\nD_real_output requires grad: {D_real_output.requires_grad}')
                print(f'D_fake_output requires grad: {D_fake_output.requires_grad}')
                print(f'generated_image requires grad: {generated_image.requires_grad}\n')

                grads = torch.autograd.grad(D_total_loss, self.discriminator.parameters(), retain_graph=True)
                for grad in grads:
                    print(grad)
