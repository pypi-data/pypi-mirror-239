...
class SignaturePlacement(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "page", "width", "height", "x", "y", "pageRotation", "rectangleOrigin", "signatureNumber", "templateType", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "page", "width", "height", "x", "y", "pageRotation", "rectangleOrigin", "signatureNumber", "templateType", ], str]):
