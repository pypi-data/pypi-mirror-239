...
class SignatureProof(
        ...
        class properties:
            ...
            class embeddedSignatureInfos(
                ...
                def __getitem__(self, i: int) -> 'SignatureInfo':
                    return super().__getitem__(i)
            proofTargetTaskId = schemas.StrSchema
            ...
            __annotations__ = {
                ...
                "proofTargetTaskId": proofTargetTaskId,
                "deletable": deletable,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["proofTargetTaskId"]) -> MetaOapg.properties.proofTargetTaskId: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "index", "contentLength", "mediaType", "pdfVisualId", "signaturePlacementAnnotations", "signatureTags", "sealTags", "detachedSignatures", "embeddedSignatureInfos", "proofTargetTaskId", "deletable", "isMainDocument", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["proofTargetTaskId"]) -> typing.Union[MetaOapg.properties.proofTargetTaskId, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "index", "contentLength", "mediaType", "pdfVisualId", "signaturePlacementAnnotations", "signatureTags", "sealTags", "detachedSignatures", "embeddedSignatureInfos", "proofTargetTaskId", "deletable", "isMainDocument", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        proofTargetTaskId: typing.Union[MetaOapg.properties.proofTargetTaskId, str, schemas.Unset] = schemas.unset,
