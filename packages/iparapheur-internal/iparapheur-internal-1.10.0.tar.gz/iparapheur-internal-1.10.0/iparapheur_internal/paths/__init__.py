...
class PathValues(str, enum.Enum):
    ...
    API_INTERNAL_ADMIN_TENANT_TENANT_ID_TEST_MAIL_TEMPLATE = "/api/internal/admin/tenant/{tenantId}/testMailTemplate"
    API_INTERNAL_ADMIN_TENANT_TENANT_ID_TEST_DOCKET_PDF_TEMPLATE = "/api/internal/admin/tenant/{tenantId}/testDocketPdfTemplate"
    API_INTERNAL_ADMIN_TENANT_TENANT_ID_SIGNATURE_TEMPLATES_TEMPLATE_TYPE_EXAMPLE = "/api/internal/admin/tenant/{tenantId}/signatureTemplates/{templateType}/example"
