...
class TestRfSignalResponseTestCase(unittest.TestCase):
    ...
    @parameterized.expand([
        ['from_dpa', 'Count: 2', TestRfSignalResponse.from_dpa(data_ok['dpa'])],
        ['from_dpa', 'Count: 0', TestRfSignalResponse.from_dpa(data_ok_1['dpa'])],
        ['from_dpa', 'Count: 383-510', TestRfSignalResponse.from_dpa(data_ok_2['dpa'])],
        ['from_json', 'Count: 2', TestRfSignalResponse.from_json(generate_json_response(data_ok))],
        ['from_json', 'Count: 0', TestRfSignalResponse.from_json(generate_json_response(data_ok_1))],
        ['from_json', 'Count: 383-510', TestRfSignalResponse.from_json(generate_json_response(data_ok_2))],
    ])
    ...
    def test_get_count_error(self, _, response: TestRfSignalResponse):
        self.assertEqual(response.get_count(), 'Count: None')
