...
class FunctionCall(pydantic.BaseModel):
    ...
    min_duration: float = 10000.0

    def __add__(self, other: "FunctionCall") -> "FunctionCall":
        """Add the call count of the one to the other."""
        self.call_count += other.call_count
        self.max_duration = max(self.duration, other.duration)
        self.min_duration = min(self.duration, other.duration)
        self.duration += other.duration / 2.0
        return self
