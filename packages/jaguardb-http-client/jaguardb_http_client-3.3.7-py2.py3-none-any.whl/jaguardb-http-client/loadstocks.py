...
def loadStocks():
    ...
    q = "select similarity(v, '" + comma_sepstr + "', 'topk=5, type=cosine_fraction_float, with_score=yes') from vdb.daily"
    ...
    page += "<br><br>\n"
    page += "<table width=700 style='border-radius: 4px; box-shadow: 0 0 12px rgba(150, 150, 150, 0.5);'>\n"
