...
"""                                                                              # toUnix
    ...
    def __ror__(self, t):                                                        # toUnix
        try: return float(t)                                                     # toUnix
            ...
            try: return dateutil.parser.parse(t).timestamp()                     # toUnix
            except: return None                                                  # toUnix
class toLinks(BaseCli):                                                          # toLinks
    def __init__(self):                                                          # toLinks
        """Grabs all links from all lines.
Example::

    lines = ["http://a.c", "http://a.c some other text in between <a href='http://b.d'>some link</a> fdvb"]
    lines | toLinks() | cli.deref() # returns ['http://a.c', 'http://a.c', 'http://b.d']
...
splendidly"""                                                                    # toLinks
        self.gr = cli.op().split(" ").all() | cli.joinSt() | cli.grep("(?P<g>http(s)?://[^\(\)\[\]\<\>\{\}\'\" ]*)", extract="g") # toLinks
    def __ror__(self, it): return it | self.gr                                   # toLinks
