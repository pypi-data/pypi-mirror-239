...
__all__ = ["serverHandle", "serverSend", "WsClient"]
...
be "abc" on the server side."""
    ...
    if obj["type"] == "msg": return obj["msg"] if obj["dataType"] == "str" else base64.b64decode(obj["msg"])
async def serverSend(ws: "websockets.WebSocketServerProtocol", msg:"any"):
    """Msg send wrapper. Basically adds some metadata to the message. See :meth:`serverHandle`"""
    return await ws.send(json.dumps({"type": "msg", "dataType": "str", "msg": msg}))
