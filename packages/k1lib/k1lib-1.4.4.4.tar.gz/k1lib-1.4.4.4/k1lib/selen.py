...
def getBrowser():                                                                # getBrowser
    """Launches new browser and return object to manage"""                       # getBrowser
    return k1.dep("selenium.webdriver").Chrome(k1.dep("webdriver_manager.chrome").ChromeDriverManager().install()) # getBrowser
def getMeta(e): # return format: obj, x, y, w, h, wh (5), type, path, %area of parent (8) # getMeta
...
def getStages(browser):                                                          # getStages
...
def drawStages(stages):                                                          # drawStages
...
class Page:                                                                      # Page
    def __init__(self, stages:"list[list[tuple(...)]]"):                         # Page
