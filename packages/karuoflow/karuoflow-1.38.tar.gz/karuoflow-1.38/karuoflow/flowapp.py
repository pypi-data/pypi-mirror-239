...
class KaruoFlow:
            ...
            if "all" in supervisor_catalogs:
                ...
                if catalog:
                    ...
                    _exclude_query_condition = [
                        and_(
                            TblFlowJob.catalog.notin_(supervisor_catalogs),
                            TblFlowJob.apply_user==user_id
                        ),
                        TblFlowJob.catalog.in_(supervisor_catalogs)
                    ]
                    _common_query.filter(or_(*_exclude_query_condition))
        else:
    ...
    def QueryApplyListInDoing(self, 
        ...
        查询用户发起的正在进行中的审批记录
        """
        return self._QueryApplySets(user_id, catalog, subflow, '0', None, page, size, supervisor_users, supervisor_catalogs, abstract, job_condition, record_condition)
    ...
    def QueryApplyListClosed(self, 
        ...
        查询用户发起的已经结束的审批记录
        """
        return self._QueryApplySets(user_id, catalog, subflow, '1', None, page, size, supervisor_users, supervisor_catalogs, abstract, job_condition, record_condition)
    ...
    def QueryApplyListSuccessed(self, 
        ...
        :param catalog 申请类别
        """
        return self._QueryApplySets(user_id, catalog, subflow, '1', '1', page, size, supervisor_users, supervisor_catalogs, abstract, job_condition, record_condition)
    ...
    def QueryApplyListRefused(self, 
        ...
        :param catalog 申请类别
        """
        return self._QueryApplySets(user_id, catalog, subflow, '1', '0', page, size, supervisor_users, supervisor_catalogs, abstract, job_condition, record_condition)
