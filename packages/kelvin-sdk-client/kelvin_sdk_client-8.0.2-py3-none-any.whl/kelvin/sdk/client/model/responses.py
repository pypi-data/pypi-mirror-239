...
class AssetHierarchyList(DataModelBase):
    ...
    def upload_assets(
        ...
        The first row of the csv file needs to be the header of the columns. `NAME,DISPLAY NAME,ASSET TYPE,DIRECT PARENT,ENTITY TYPE`.
...
class PlannerRulesResponse(DataModelBase):
    ...
    def get_app_planner_rules(
        ...
        **Permission Required:** `kelvin.permission.appmanager.read`.
        ...
        ``getAppPlannerRules``: ``GET`` ``/api/v4/app-manager/planner-rules/app/{app_name}/get``
        ...
        result = cls._make_request(
            _client,
            "get",
            "/api/v4/app-manager/planner-rules/app/{app_name}/get",
            {"app_name": app_name},
            {},
            {},
            {},
    ...
    def update_app_planner_rules(
        ...
        **Permission Required:** `kelvin.permission.appmanager.update`.
        ...
        ``updateAppPlannerRules``: ``POST`` ``/api/v4/app-manager/planner-rules/app/{app_name}/update``
        ...
        **kwargs:
        ...
        result = self_or_cls._make_request(
            _client,
            "post",
            "/api/v4/app-manager/planner-rules/app/{app_name}/update",
            {"app_name": app_name},
            {},
            {},
            {},
