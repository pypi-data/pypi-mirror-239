...
class Ingredient:
    ...
    def capture(self, function=None, prefix=None, static_args={}, add_default_args_to_config= True, **extra_args):
        """
        ...
        if function in self.captured_functions:
            return function
        if add_default_args_to_config:
            self.add_default_args_to_config(function, prefix, static_args=static_args, extra_args=extra_args)
    ...
    @optional_kwargs_decorator
    def command(self, function=None, prefix=None, unobserved=False, add_default_args_to_config=True, static_args={}, **kw_args):
        """
        ...
        :param add_default_args_to_config: wether to add the default arguments of the function to the config automatically.
        ...
        :param **kw_args: explicit arguments to be add to the config, you can these to override the function default
        values. For example, using a CMD config, then the parameter will be filled with excuting the command
        specified by CMD string value. CMD string have special context

        """
        add_default_args_to_config = (not unobserved) and add_default_args_to_config
        captured_f = self.capture(function, prefix=prefix, static_args=static_args, add_default_args_to_config=add_default_args_to_config, **kw_args)
        captured_f.unobserved = unobserved
        self.commands[function.__name__] = captured_f
        return captured_f
    
    def add_default_args_to_config(self, function, prefix, extra_args={}, static_args={}):
        """
