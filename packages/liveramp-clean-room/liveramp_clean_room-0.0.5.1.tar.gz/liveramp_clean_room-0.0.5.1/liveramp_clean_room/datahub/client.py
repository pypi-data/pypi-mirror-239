...
class Client:
    ...
    def share_table_or_view(
            ...
            asset_ids: list[str],
            partner_id: str,
            allow_joining_with_partners_data: bool,
            allow_joining_with_data_providers_data: bool,
            allow_joining_with_other_orgs_data: bool,
            allow_joining_with_specific_orgs_data: list[str],
            minimum_aggregation_column: str = None,
            minimum_aggregation_records: int = None,
            number_of_days: int = None,
    ):
        """
