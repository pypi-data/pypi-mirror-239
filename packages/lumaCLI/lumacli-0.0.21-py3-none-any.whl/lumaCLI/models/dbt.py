...
class Node(BaseModel):
    """
    Fields common for every Node (models, seeds, tests).
    """
...
class BundleJson(BaseModel):
    manifest_json: Optional[ManifestDict]
    catalog_json: Optional[CatalogDict]
    sources_json: Optional[SourcesDict]
    run_results_json: Optional[RunResultsDict]
