...
from mddocs.commands.build import build
from mddocs.config import load_config
...
def serve(config_file=None, dev_addr=None, strict=None, theme=None,
    ...
    """
    Start the MdDocs development server
    ...
    # string is returned. And it makes MdDocs temp dirs easier to identify.
    site_dir = tempfile.mkdtemp(prefix='mddocs_')
