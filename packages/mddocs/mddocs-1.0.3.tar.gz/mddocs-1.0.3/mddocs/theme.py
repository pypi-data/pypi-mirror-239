...
from mddocs.utils import filters
from mddocs.config.base import ValidationError
...
class Theme(object):
    ...
    def __init__(self, name=None, **user_config):
        ...
        # MdDocs provided static templates are always included
        package_dir = os.path.abspath(os.path.dirname(__file__))
        mddocs_templates = os.path.join(package_dir, 'templates')
        self.static_templates = set(os.listdir(mddocs_templates))
        ...
        # Include templates provided directly by MdDocs (outside any theme)
        self.dirs.append(mddocs_templates)
    ...
    def _load_theme_config(self, name):
        ...
        try:
            file_path = os.path.join(theme_dir, 'mddocs_theme.yml')
