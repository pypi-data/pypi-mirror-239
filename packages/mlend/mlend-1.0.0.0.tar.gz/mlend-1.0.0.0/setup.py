...
if os.path.isfile(os.path.join(top_dir, 'Version')):
    ...
    import urllib
    Vpath = 'https://raw.githubusercontent.com/MLEndDatasets/MLEnd/master/Version'
...
if __name__ == "__main__":
    ...
    setuptools.setup(
        ...
        url=URL,
        download_url = 'https://github.com/MLEndDatasets/MLEnd/tarball/' + version,
        ...
        'Say Thanks!': 'https://github.com/MLEndDatasets',
        'Source': 'https://github.com/MLEndDatasets/MLEnd',
        'Tracker': 'https://github.com/MLEndDatasets/MLEnd/issues',
        },
