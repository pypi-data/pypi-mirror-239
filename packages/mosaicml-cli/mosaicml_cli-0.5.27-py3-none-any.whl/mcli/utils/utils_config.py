...
class DictTranslation(Translation, Generic[T]):
    """ABC for MAPI/MCLI translations for dictionary objects
    
    TODO: Most Translation classes should just inherit from this class,
    but typing is hard
    """
