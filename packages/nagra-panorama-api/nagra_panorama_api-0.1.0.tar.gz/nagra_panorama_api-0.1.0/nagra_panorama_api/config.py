...
class ConfigElement:
    ...
    def dumps(self, pretty=False):
        return etree.tostring(self._el, pretty_print=pretty).decode()
...
class Config:
    ...
    def __init__(self, config_tree):
        assert config_tree.tag == 'config'
        detach(config_tree)
        self._tree = config_tree

    # def __str__(self):
    #     return etree.tostring(self._tree).decode()

    def dumps(self, pretty=False):
        return etree.tostring(self._tree, pretty_print=pretty).decode()
