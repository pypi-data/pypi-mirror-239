...
def test_add_methods_exist():
    # Arrange
    netdot.Device.prepare_class()
    netdot.ContactList.prepare_class()
    netdot.DeviceContacts.prepare_class()
...
def test_load_methods_exist():
    # Arrange
    netdot.Site.prepare_class()
    netdot.SiteSubnet.prepare_class()
