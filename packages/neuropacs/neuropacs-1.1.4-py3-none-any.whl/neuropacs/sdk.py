...
class neuropacs:
    ...
    def upload (self, file_path, connectionID, order_id, aes_key):
        ...
        if(os.path.isfile(file_path)):
            ...
            with open(file_path, 'rb') as f:
                ...
                headers = {
                "Content-Type": "application/octet-stream",'connection-id': connectionID, 'client': 'API', 'order-id': encrypted_order_id
                }
    ...
    def get_result(self, connection_id, aes_key, orderID):
