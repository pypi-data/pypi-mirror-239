...
#UPLOAD AN IMAGE
upload_status = npcs.upload("your_image_path",connection_id, order_id, aes_key)

#UPLOAD A DATASET
upload_status = npcs.upload_dataset("your_dataset_path",connection_id, order_id, aes_key)
...
#RETRIEVE JOB RESULTS [COMING SOON]
job_results = npcs.get_results()
```
