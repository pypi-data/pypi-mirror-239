    ...
    with gr.Blocks() as demo:
        ...
        with gr.Tab(label="Training"):
            with gr.Row():
                with gr.Column(scale=1):
                    ...
                    geneder = gr.Radio(choices=["man", "woman"], value="man", label="Gender")
        ...
        with gr.Tab(label="Inferencing"):
            ...
            generate_button.click(
                inputs=[novita_key, style_gender, style_prompt, style_negative_prompt, style_model, style_lora, _hide_lora_training_response,
