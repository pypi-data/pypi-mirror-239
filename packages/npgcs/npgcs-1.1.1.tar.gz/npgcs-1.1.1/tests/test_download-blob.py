...
if __name__ == "__main__":
    ...
    # blobs = gcs.list_gcs_blobs(bucket_name, prefix="fwd")
    blobs = gcs.list_blobs(bucket_name, prefix="fwd")
    for blob in blobs:
        blob_name = blob.get("blob_name")
        gcs.download_blob(bucket_name, blob_name, blob_name)
        gcs.download_blob(bucket_name, blob_name)
