...
def test_modal_inman_4_6_1():
    ...
    #TODO verify the validity of this test
    np.testing.assert_almost_equal(tmck.B_tilde.dot(np.array([[1,1]]).T), np.sqrt(2)/2*np.array([[-1,1]]).T, 4)




def test_INCOMPLETE_modal_inman_4_6_1_calc_xs():
