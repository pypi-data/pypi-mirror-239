...
def test_Thetaint():
    ...
    Thetaint = np.array(
        [nm.Thetaint(t, alpha, beta, delta, omega_prec, omega_spin) for t in time]
    )
...
def test_Thetaext():
    ...
    Thetaext = np.array(
        [nm.Thetaext(t, alpha, beta, delta, omega_prec, omega_spin) for t in time]
    )
