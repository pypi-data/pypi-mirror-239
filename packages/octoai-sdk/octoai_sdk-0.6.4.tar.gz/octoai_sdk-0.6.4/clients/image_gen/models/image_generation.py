...
class ImageGeneration(BaseModel):
    ...
    image_b64: Optional[StrictStr] = Field(
        None, description="The generated image or None if removed for safety."
    )
    removed_for_safety: StrictBool = Field(
        ...,
        description="Boolean defining if there were or not images removed for safety.",
    )
    __properties = ["image_b64", "removed_for_safety"]
