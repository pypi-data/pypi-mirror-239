...
class DbTemplates(TypedDict):
    ...
    name: Literal[
        'Advanced United States Greenfield Facility Selection (2.7.14)',
        'Advanced United States Greenfield Facility Selection',
        'Anura New Model v2.7.14.1',
        'Anura New Model',
        'China Exit Risk Strategy (2.7.14)',
        'China Exit Risk Strategy',
        'China Exit Strategy in Asia (2.7.14)',
        'China Exit Strategy in Asia',
        'Detailed Facility Selection (2.7.14)',
        'Detailed Facility Selection',
        'Empty Database',
        'Fleet Size Optimization - EMEA Geo (2.7.14)',
        'Fleet Size Optimization - EMEA Geo',
        'Fleet Size Optimization - US Geo (2.7.14)',
        'Fleet Size Optimization - US Geo',
        'Global Risk Analysis (2.7.14)',
        'Global Risk Analysis',
        'Global Sourcing - Cost To Serve (2.7.14)',
        ...
        'Tactical Capacity Optimization (2.7.14)',
        'Tactical Capacity Optimization',
        'Transportation Optimization',
        'United States Greenfield Facility Selection (2.7.14)',
...
class Api:
    ...
    DATABASE_TEMPLATES_NEW: Tuple[DbTemplates, ...] = (
        ...
        {'id': '7.13', 'name': 'Anura New Model v2.7.14.1'},
        {'id': '7.6', 'name': 'Anura New Model'},
        {'id': '9.1', 'name': 'Global Supply Chain Strategy (2.7.14)'},
        {'id': '9.2023092508324', 'name': 'Global Supply Chain Strategy'},
        {'id': '12.20230925083242', 'name': 'Tactical Capacity Optimization'},
        {'id': '12.7', 'name': 'Tactical Capacity Optimization (2.7.14)'},
        {'id': '15.20230925083242', 'name': 'Detailed Facility Selection'},
        {'id': '15.6', 'name': 'Detailed Facility Selection (2.7.14)'},
        {'id': '18.20230925084416', 'name': 'United States Greenfield Facility Selection'},
        {'id': '18.7', 'name': 'United States Greenfield Facility Selection (2.7.14)'},
        {'id': '21.20230925084431', 'name': 'China Exit Strategy in Asia'},
        {'id': '21.6', 'name': 'China Exit Strategy in Asia (2.7.14)'},
        {'id': '24.20230925083847', 'name': 'China Exit Risk Strategy'},
        {'id': '24.7', 'name': 'China Exit Risk Strategy (2.7.14)'},
        {'id': '27.6', 'name': 'Multi-Year Capacity Planning'},
        {'id': '27.7', 'name': 'Multi-Year Capacity Planning (2.7.14)'},
        {'id': '28.20230925083242', 'name': 'Fleet Size Optimization - EMEA Geo'},
        {'id': '28.6', 'name': 'Fleet Size Optimization - EMEA Geo (2.7.14)'},
        {'id': '29.20230925083241', 'name': 'Global Risk Analysis'},
        {'id': '29.5', 'name': 'Global Risk Analysis (2.7.14)'},
        {'id': '30.20230925083242', 'name': 'Fleet Size Optimization - US Geo'},
        {'id': '30.6', 'name': 'Fleet Size Optimization - US Geo (2.7.14)'},
        {'id': '31.20230925084458', 'name': 'Global Sustainability Analysis'},
        {'id': '31.5', 'name': 'Global Sustainability Analysis (2.7.14)'},
        {'id': '32.20230925083852', 'name': 'Global Sourcing - Cost To Serve'},
        {'id': '32.5', 'name': 'Global Sourcing - Cost To Serve (2.7.14)'},
        {'id': '35.2', 'name': 'Advanced United States Greenfield Facility Selection (2.7.14)'},
        {'id': '35.20230921133352', 'name': 'Advanced United States Greenfield Facility Selection'},
        {'id': '36.2', 'name': 'Outbound Distribution Simulation (2.7.14)'},
    ...
    DATABASE_TEMPLATES_NAMEID: Dict[str, str] = {
        ...
        'China Exit Strategy in Asia (2.7.14)': '4c8ca082-776f-11ee-a0df-0d9d492442f8',
        'China Exit Strategy in Asia': '48275960-5448-4aed-b5e4-2f852bf8f985',
        'Detailed Facility Selection (2.7.14)': '5e72dcc6-776f-11ee-a0df-0d9d492442f8',
        'Detailed Facility Selection': '2f070371-5850-46b9-9227-327a19f3f7bb',
        'Empty Database': 'template1',
        'Fleet Size Optimization - EMEA Geo (2.7.14)': '738289f4-776f-11ee-a0df-0d9d492442f8',
        'Fleet Size Optimization - EMEA Geo': 'af9630ce-fe0a-4e9b-ba6d-0d05944d8ef5',
        'Fleet Size Optimization - US Geo (2.7.14)': 'be31bf4a-7776-11ee-a0df-0d9d492442f8',
        'Fleet Size Optimization - US Geo': 'e0a12e51-d00c-43f6-abf6-07b328d4f270',
        'Global Risk Analysis (2.7.14)': '9cb56f8a-776f-11ee-a0df-0d9d492442f8',
        'Global Risk Analysis': '5d4bd0fc-1da8-4807-a560-528cb841659e',
        'Global Sourcing - Cost To Serve (2.7.14)': 'b609a604-776f-11ee-a0df-0d9d492442f8',
        ...
        'United States Greenfield Facility Selection (2.7.14)': '4214e028-7770-11ee-a0df-0d9d492442f8',
