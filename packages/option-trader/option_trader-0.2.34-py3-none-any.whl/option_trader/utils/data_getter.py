...
def pick_option_long( symbol, 
    ...
    if otype == at.PUT:
        i = single_df.shape[0]         
        singl_df = single_df[(single_df[position_summary.BREAKEVEN_H]/single_df[position_summary.TARGET_HIGH]) > 1.0]
...
def pick_put_butterfly(symbol,                          
    ...
    if credit:
        i = butterfly_df.shape[0]               
        butterfly_df = butterfly_df[((butterfly_df[position_summary.BREAKEVEN_L]/butterfly_df[position_summary.TARGET_LOW])<1.03) &  ((butterfly_df[position_summary.BREAKEVEN_H]/butterfly_df[position_summary.TARGET_HIGH]) > 1.01)]
        logger.debug('%d -> %d reduced l/low < 1.03 & h/high > 1.01' % (i, butterfly_df.shape[0]))     
        '''
        ...
        [cpb l/low <1.03 or h/high > 1.01] [66.67%|12|6]	[1233.67|-726.50]	17.82%
            HIT	 [57.14%|4|3]	[892.75|-928.67]	3.96%
            UNDER	 [80.00%|8|2]	[1404.12|-536.50]	7.92%
            ABOVE	 [0.00%|0|1]	[nan|-500.00]	0.00%
        '''        
    else:
        i = butterfly_df.shape[0]               
