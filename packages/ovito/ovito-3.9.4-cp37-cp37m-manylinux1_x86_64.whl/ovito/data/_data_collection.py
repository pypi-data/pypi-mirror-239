...
def __DataCollection_apply(self, modifier, frame = None):
    ...
    if not isinstance(modifier, Modifier):
        if isinstance(modifier, ovito.pipeline.ModifierInterface):
            # Automatically wrap ModifierInterface objects in a PythonScriptModifier object.
            modifier = PythonScriptModifier(delegate=modifier)
        elif callable(modifier):
            # Automatically wrap freestanding Python methods in a PythonScriptModifier object.
