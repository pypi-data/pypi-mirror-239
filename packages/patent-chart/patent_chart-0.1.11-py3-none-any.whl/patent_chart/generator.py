...
async def aopenai_chat_completion_request_with_retry(model_name, messages, backoff_factor=2, backoff_override=None, n_retries=8, rate_limiter: Optional[FixedWindowRateLimiter] = None, **kwargs) -> dict:
