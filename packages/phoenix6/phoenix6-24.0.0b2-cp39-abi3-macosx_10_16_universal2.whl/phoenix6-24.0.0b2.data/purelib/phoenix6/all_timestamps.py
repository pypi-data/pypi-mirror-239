...
class AllTimestamps:
    ...
    def update(
        ...
        :type system_timestamp_seconds: float
        ...
        :type canivore_timestamp_seconds: float
        ...
        :type device_timestamp_seconds: float
    ...
    def get_best_timestamp(self) -> Timestamp:
        ...
        :rtype: Timestamp
        """
        if self.__canivore_timestamp.get_valid():
