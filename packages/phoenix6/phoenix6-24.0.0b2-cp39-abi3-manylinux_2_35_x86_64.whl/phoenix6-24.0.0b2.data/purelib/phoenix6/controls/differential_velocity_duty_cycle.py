...
class DifferentialVelocityDutyCycle:
    def __init__(self, target_velocity: float, differential_position: float, enable_foc: bool, target_slot: int, differential_slot: int, override_brake_dur_neutral: bool):
        """
        ...
        """
        self.control_info = {}
        self.control_info["name"] = "DifferentialVelocityDutyCycle"
