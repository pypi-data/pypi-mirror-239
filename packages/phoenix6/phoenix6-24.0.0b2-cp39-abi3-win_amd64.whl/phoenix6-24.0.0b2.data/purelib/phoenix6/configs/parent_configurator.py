...
class ParentConfigurator:
    def __init__(self, device_identifier: DeviceIdentifier):
        self.default_timeout_seconds = 0.050
        self.__device_identifier = device_identifier

    def _set_configs_private(self, serial_string: str, timeout_seconds: float, future_proof_configs: bool, override_if_duplicate: bool):
    ...
    def _get_configs_private(self, timeout_seconds: float) -> (StatusCode, str):
