...
class MotionMagicVelocityTorqueCurrentFOC:
    def __init__(self, velocity: float, acceleration: float, enable_foc: bool, feed_forward: float, slot: int, override_coast_dur_neutral: bool):
        """
        ...
        """
        self.control_info = {}
        self.control_info["name"] = "MotionMagicVelocityTorqueCurrentFOC"
