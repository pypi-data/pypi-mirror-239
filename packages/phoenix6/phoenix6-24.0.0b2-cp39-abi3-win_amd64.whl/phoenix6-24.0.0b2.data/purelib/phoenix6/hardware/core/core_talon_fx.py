...
class CoreTalonFX(ParentDevice):
    ...
    def get_ancillary_device_temp(self) -> StatusSignal[celcius]:
        """
        ...
        """
        return self._common_lookup(SpnValue.PRO_SUPPLY_AND_TEMP_DEVICE_TEMP2.value, 0, None, "ancillary_device_temp", True, celcius)
