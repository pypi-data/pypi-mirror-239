...
import pixlib
from pixlib import __version__, __license__
from pixlib import enums
from pixlib import raw
from pixlib import utils
from pixlib.crypto import aes
from pixlib.errors import CDNFileHashMismatch
from pixlib.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    AuthBytesInvalid, BadRequest, ListenerCanceled
)
from pixlib.handlers.handler import Handler
from pixlib.methods import Methods
from pixlib.session import Auth, Session
from pixlib.storage import FileStorage, MemoryStorage
from pixlib.types import User, TermsOfService
from pixlib.utils import ginput
...
class Client(Methods):
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~pixlib.Client.export_session_string` before stopping the client to get a session string you can
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~pixlib.enums.ParseMode`):
        ...
        try:
            ...
            if isinstance(r, raw.types.upload.File):
                ...
                try:
                    ...
                    raise e
        except pixlib.StopTransmission:
            raise
        except Exception as e:
            log.error(e, exc_info=True)
