...
import pixlib
from pixlib import StopTransmission, enums
from pixlib import raw
from pixlib import types
from pixlib import utils
from pixlib.errors import FilePartMissing
from pixlib.file_id import FileType
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~pixlib.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~pixlib.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~pixlib.Client.stop_transmission`, None is returned.
