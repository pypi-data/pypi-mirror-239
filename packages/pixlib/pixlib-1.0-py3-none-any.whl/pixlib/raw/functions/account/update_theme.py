...
class UpdateTheme(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        document (:obj:`InputDocument <pixlib.raw.base.InputDocument>`, *optional*):
            N/A

        settings (List of :obj:`InputThemeSettings <pixlib.raw.base.InputThemeSettings>`, *optional*):
            N/A

    Returns:
        :obj:`Theme <pixlib.raw.base.Theme>`
    """
