...
class VerifyEmail(TLObject):  # type: ignore
    ...
    Parameters:
        purpose (:obj:`EmailVerifyPurpose <pixlib.raw.base.EmailVerifyPurpose>`):
            N/A

        verification (:obj:`EmailVerification <pixlib.raw.base.EmailVerification>`):
            N/A

    Returns:
        :obj:`account.EmailVerified <pixlib.raw.base.account.EmailVerified>`
    """
