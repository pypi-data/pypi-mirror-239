...
class InitConnection(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        query (Any function from :obj:`~pixlib.raw.functions`):
            N/A

        proxy (:obj:`InputClientProxy <pixlib.raw.base.InputClientProxy>`, *optional*):
            N/A

        params (:obj:`JSONValue <pixlib.raw.base.JSONValue>`, *optional*):
            N/A

    Returns:
        Any object from :obj:`~pixlib.raw.types`
    """
