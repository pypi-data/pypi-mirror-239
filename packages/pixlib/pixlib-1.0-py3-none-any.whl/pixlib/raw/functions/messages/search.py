...
class Search(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        filter (:obj:`MessagesFilter <pixlib.raw.base.MessagesFilter>`):
            N/A
        ...
        from_id (:obj:`InputPeer <pixlib.raw.base.InputPeer>`, *optional*):
            N/A
    ...
    Returns:
        :obj:`messages.Messages <pixlib.raw.base.messages.Messages>`
    """
