...
class ValidateRequestedInfo(TLObject):  # type: ignore
    ...
    Parameters:
        invoice (:obj:`InputInvoice <pixlib.raw.base.InputInvoice>`):
            N/A

        info (:obj:`PaymentRequestedInfo <pixlib.raw.base.PaymentRequestedInfo>`):
            N/A
    ...
    Returns:
        :obj:`payments.ValidatedRequestedInfo <pixlib.raw.base.payments.ValidatedRequestedInfo>`
    """
