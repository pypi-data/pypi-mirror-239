...
class GetGroupParticipants(TLObject):  # type: ignore
    ...
    Parameters:
        call (:obj:`InputGroupCall <pixlib.raw.base.InputGroupCall>`):
            N/A

        ids (List of :obj:`InputPeer <pixlib.raw.base.InputPeer>`):
            N/A
    ...
    Returns:
        :obj:`phone.GroupParticipants <pixlib.raw.base.phone.GroupParticipants>`
    """
