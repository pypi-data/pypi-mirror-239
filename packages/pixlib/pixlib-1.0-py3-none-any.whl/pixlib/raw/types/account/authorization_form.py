...
class AuthorizationForm(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pixlib.raw.base.account.AuthorizationForm`.
    ...
    Parameters:
        required_types (List of :obj:`SecureRequiredType <pixlib.raw.base.SecureRequiredType>`):
            N/A

        values (List of :obj:`SecureValue <pixlib.raw.base.SecureValue>`):
            N/A

        errors (List of :obj:`SecureValueError <pixlib.raw.base.SecureValueError>`):
            N/A
