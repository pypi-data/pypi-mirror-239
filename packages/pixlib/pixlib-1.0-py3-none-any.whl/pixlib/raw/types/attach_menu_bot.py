...
class AttachMenuBot(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pixlib.raw.base.AttachMenuBot`.
    ...
    Parameters:
        ...
        peer_types (List of :obj:`AttachMenuPeerType <pixlib.raw.base.AttachMenuPeerType>`):
            N/A

        icons (List of :obj:`AttachMenuBotIcon <pixlib.raw.base.AttachMenuBotIcon>`):
            N/A
