...
class AttachMenuBotIcon(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pixlib.raw.base.AttachMenuBotIcon`.
    ...
    Parameters:
        ...
        icon (:obj:`Document <pixlib.raw.base.Document>`):
            N/A

        colors (List of :obj:`AttachMenuBotIconColor <pixlib.raw.base.AttachMenuBotIconColor>`, *optional*):
            N/A
