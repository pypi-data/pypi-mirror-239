...
class SentCode(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pixlib.raw.base.auth.SentCode`.
    ...
    Parameters:
        type (:obj:`auth.SentCodeType <pixlib.raw.base.auth.SentCodeType>`):
            N/A

        phone_code_hash (``str``):
            N/A

        next_type (:obj:`auth.CodeType <pixlib.raw.base.auth.CodeType>`, *optional*):
            N/A
