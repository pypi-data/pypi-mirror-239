...
class BotInlineResult(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pixlib.raw.base.BotInlineResult`.
    ...
    Parameters:
        ...
        send_message (:obj:`BotInlineMessage <pixlib.raw.base.BotInlineMessage>`):
            N/A
        ...
        thumb (:obj:`WebDocument <pixlib.raw.base.WebDocument>`, *optional*):
            N/A

        content (:obj:`WebDocument <pixlib.raw.base.WebDocument>`, *optional*):
            N/A
