...
class ChannelAdminLogEventActionParticipantToggleAdmin(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pixlib.raw.base.ChannelAdminLogEventAction`.
    ...
    Parameters:
        prev_participant (:obj:`ChannelParticipant <pixlib.raw.base.ChannelParticipant>`):
            N/A

        new_participant (:obj:`ChannelParticipant <pixlib.raw.base.ChannelParticipant>`):
            N/A
