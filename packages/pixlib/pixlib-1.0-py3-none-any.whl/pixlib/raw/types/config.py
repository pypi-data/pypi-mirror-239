...
class Config(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pixlib.raw.base.Config`.
    ...
    Parameters:
        ...
        dc_options (List of :obj:`DcOption <pixlib.raw.base.DcOption>`):
            N/A
        ...
        reactions_default (:obj:`Reaction <pixlib.raw.base.Reaction>`, *optional*):
            N/A
