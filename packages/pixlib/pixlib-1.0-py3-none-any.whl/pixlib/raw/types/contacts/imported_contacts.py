...
class ImportedContacts(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pixlib.raw.base.contacts.ImportedContacts`.
    ...
    Parameters:
        imported (List of :obj:`ImportedContact <pixlib.raw.base.ImportedContact>`):
            N/A

        popular_invites (List of :obj:`PopularContact <pixlib.raw.base.PopularContact>`):
            N/A
