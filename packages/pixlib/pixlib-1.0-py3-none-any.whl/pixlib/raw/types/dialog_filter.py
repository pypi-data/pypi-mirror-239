...
class DialogFilter(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pixlib.raw.base.DialogFilter`.
    ...
    Parameters:
        ...
        pinned_peers (List of :obj:`InputPeer <pixlib.raw.base.InputPeer>`):
            N/A

        include_peers (List of :obj:`InputPeer <pixlib.raw.base.InputPeer>`):
            N/A

        exclude_peers (List of :obj:`InputPeer <pixlib.raw.base.InputPeer>`):
            N/A
