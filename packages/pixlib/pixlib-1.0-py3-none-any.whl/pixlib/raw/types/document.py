...
class Document(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pixlib.raw.base.Document`.
    ...
    Parameters:
        ...
        thumbs (List of :obj:`PhotoSize <pixlib.raw.base.PhotoSize>`, *optional*):
            N/A

        video_thumbs (List of :obj:`VideoSize <pixlib.raw.base.VideoSize>`, *optional*):
            N/A
