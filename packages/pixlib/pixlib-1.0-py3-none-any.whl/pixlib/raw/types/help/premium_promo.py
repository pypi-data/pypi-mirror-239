...
class PremiumPromo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pixlib.raw.base.help.PremiumPromo`.
    ...
    Parameters:
        ...
        status_entities (List of :obj:`MessageEntity <pixlib.raw.base.MessageEntity>`):
            N/A

        video_sections (List of ``str``):
            N/A

        videos (List of :obj:`Document <pixlib.raw.base.Document>`):
            N/A

        period_options (List of :obj:`PremiumSubscriptionOption <pixlib.raw.base.PremiumSubscriptionOption>`):
            N/A
