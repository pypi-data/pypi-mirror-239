...
class InputBotInlineMessageMediaInvoice(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pixlib.raw.base.InputBotInlineMessage`.
    ...
    Parameters:
        ...
        provider_data (:obj:`DataJSON <pixlib.raw.base.DataJSON>`):
            N/A

        photo (:obj:`InputWebDocument <pixlib.raw.base.InputWebDocument>`, *optional*):
            N/A
