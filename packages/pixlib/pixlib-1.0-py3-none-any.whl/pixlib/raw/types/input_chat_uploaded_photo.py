...
class InputChatUploadedPhoto(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pixlib.raw.base.InputChatPhoto`.
    ...
    Parameters:
        file (:obj:`InputFile <pixlib.raw.base.InputFile>`, *optional*):
            N/A

        video (:obj:`InputFile <pixlib.raw.base.InputFile>`, *optional*):
            N/A
