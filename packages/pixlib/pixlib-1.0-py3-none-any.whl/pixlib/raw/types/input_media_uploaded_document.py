...
class InputMediaUploadedDocument(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pixlib.raw.base.InputMedia`.
    ...
    Parameters:
        file (:obj:`InputFile <pixlib.raw.base.InputFile>`):
            N/A

        mime_type (``str``):
            N/A

        attributes (List of :obj:`DocumentAttribute <pixlib.raw.base.DocumentAttribute>`):
            N/A
        ...
        thumb (:obj:`InputFile <pixlib.raw.base.InputFile>`, *optional*):
            N/A

        stickers (List of :obj:`InputDocument <pixlib.raw.base.InputDocument>`, *optional*):
            N/A
