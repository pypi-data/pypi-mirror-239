...
class MessageReactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pixlib.raw.base.MessageReactions`.
    ...
    Parameters:
        results (List of :obj:`ReactionCount <pixlib.raw.base.ReactionCount>`):
            N/A
        ...
        recent_reactions (List of :obj:`MessagePeerReaction <pixlib.raw.base.MessagePeerReaction>`, *optional*):
            N/A
