...
class BotResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pixlib.raw.base.messages.BotResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`BotInlineResult <pixlib.raw.base.BotInlineResult>`):
            N/A
        ...
        switch_pm (:obj:`InlineBotSwitchPM <pixlib.raw.base.InlineBotSwitchPM>`, *optional*):
            N/A
