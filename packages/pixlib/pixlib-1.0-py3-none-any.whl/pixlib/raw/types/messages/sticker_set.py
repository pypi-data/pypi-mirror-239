...
class StickerSet(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pixlib.raw.base.messages.StickerSet`.
    ...
    Parameters:
        set (:obj:`StickerSet <pixlib.raw.base.StickerSet>`):
            N/A

        packs (List of :obj:`StickerPack <pixlib.raw.base.StickerPack>`):
            N/A

        keywords (List of :obj:`StickerKeyword <pixlib.raw.base.StickerKeyword>`):
            N/A

        documents (List of :obj:`Document <pixlib.raw.base.Document>`):
            N/A
