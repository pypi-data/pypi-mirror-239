...
class PageBlockRelatedArticles(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pixlib.raw.base.PageBlock`.
    ...
    Parameters:
        title (:obj:`RichText <pixlib.raw.base.RichText>`):
            N/A

        articles (List of :obj:`PageRelatedArticle <pixlib.raw.base.PageRelatedArticle>`):
            N/A
