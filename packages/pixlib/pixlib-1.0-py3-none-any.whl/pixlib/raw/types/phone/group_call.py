...
class GroupCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pixlib.raw.base.phone.GroupCall`.
    ...
    Parameters:
        call (:obj:`GroupCall <pixlib.raw.base.GroupCall>`):
            N/A

        participants (List of :obj:`GroupCallParticipant <pixlib.raw.base.GroupCallParticipant>`):
            N/A
