...
class PhoneCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pixlib.raw.base.PhoneCall`.
    ...
    Parameters:
        ...
        protocol (:obj:`PhoneCallProtocol <pixlib.raw.base.PhoneCallProtocol>`):
            N/A

        connections (List of :obj:`PhoneConnection <pixlib.raw.base.PhoneConnection>`):
            N/A
