...
class Photo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pixlib.raw.base.Photo`.
    ...
    Parameters:
        ...
        sizes (List of :obj:`PhotoSize <pixlib.raw.base.PhotoSize>`):
            N/A
        ...
        video_sizes (List of :obj:`VideoSize <pixlib.raw.base.VideoSize>`, *optional*):
            N/A
