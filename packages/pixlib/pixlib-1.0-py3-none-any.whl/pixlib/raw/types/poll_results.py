...
class PollResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pixlib.raw.base.PollResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`PollAnswerVoters <pixlib.raw.base.PollAnswerVoters>`, *optional*):
            N/A
        ...
        solution_entities (List of :obj:`MessageEntity <pixlib.raw.base.MessageEntity>`, *optional*):
            N/A
