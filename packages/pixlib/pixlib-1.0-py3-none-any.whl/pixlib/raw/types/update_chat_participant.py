...
class UpdateChatParticipant(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        prev_participant (:obj:`ChatParticipant <pixlib.raw.base.ChatParticipant>`, *optional*):
            N/A

        new_participant (:obj:`ChatParticipant <pixlib.raw.base.ChatParticipant>`, *optional*):
            N/A
