...
class DifferenceSlice(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pixlib.raw.base.updates.Difference`.
    ...
    Parameters:
        new_messages (List of :obj:`Message <pixlib.raw.base.Message>`):
            N/A

        new_encrypted_messages (List of :obj:`EncryptedMessage <pixlib.raw.base.EncryptedMessage>`):
            N/A

        other_updates (List of :obj:`Update <pixlib.raw.base.Update>`):
            N/A
        ...
        intermediate_state (:obj:`updates.State <pixlib.raw.base.updates.State>`):
            N/A
