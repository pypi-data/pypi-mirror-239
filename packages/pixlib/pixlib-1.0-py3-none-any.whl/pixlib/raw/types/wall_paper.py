...
class WallPaper(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pixlib.raw.base.WallPaper`.
    ...
    Parameters:
        ...
        document (:obj:`Document <pixlib.raw.base.Document>`):
            N/A
        ...
        settings (:obj:`WallPaperSettings <pixlib.raw.base.WallPaperSettings>`, *optional*):
            N/A
