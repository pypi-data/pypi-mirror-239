...
class WebPageAttributeTheme(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pixlib.raw.base.WebPageAttribute`.
    ...
    Parameters:
        documents (List of :obj:`Document <pixlib.raw.base.Document>`, *optional*):
            N/A

        settings (:obj:`ThemeSettings <pixlib.raw.base.ThemeSettings>`, *optional*):
            N/A
