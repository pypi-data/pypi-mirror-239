...
from pixlib.connection import Connection
from pixlib.crypto import aes, rsa, prime
from pixlib.errors import SecurityCheckMismatch
from pixlib.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "pixlib.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
