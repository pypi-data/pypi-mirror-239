...
class Chat(Object):
    ...
    Parameters:
        ...
        type (:obj:`~pixlib.enums.ChatType`):
            Type of chat.
        ...
        photo (:obj:`~pixlib.types.ChatPhoto`, *optional*):
            Chat photo. Suitable for downloads only.

        bio (``str``, *optional*):
            Bio of the other party in a private chat.
            Returned only in :meth:`~pixlib.Client.get_chat`.
        ...
        restrictions (List of :obj:`~pixlib.types.Restriction`, *optional*):
            The list of reasons why this chat might be unavailable to some users.
            This field is available only in case *is_restricted* is True.

        permissions (:obj:`~pixlib.types.ChatPermissions` *optional*):
            Default chat member permissions, for groups and supergroups.

        distance (``int``, *optional*):
            Distance in meters of this group chat from your location.
            Returned only in :meth:`~pixlib.Client.get_nearby_chats`.

        linked_chat (:obj:`~pixlib.types.Chat`, *optional*):
            The linked discussion group (in case of channels) or the linked channel (in case of supergroups).
            Returned only in :meth:`~pixlib.Client.get_chat`.

        send_as_chat (:obj:`~pixlib.types.Chat`, *optional*):
            The default "send_as" chat.
            Returned only in :meth:`~pixlib.Client.get_chat`.

        available_reactions (:obj:`~pixlib.types.ChatReactions`, *optional*):
    ...
    async def archive(self):
        """Bound method *archive* of :obj:`~pixlib.types.Chat`.
    ...
    async def unarchive(self):
        """Bound method *unarchive* of :obj:`~pixlib.types.Chat`.
    ...
    async def set_title(self, title: str) -> bool:
        """Bound method *set_title* of :obj:`~pixlib.types.Chat`.
    ...
    async def set_description(self, description: str) -> bool:
        """Bound method *set_description* of :obj:`~pixlib.types.Chat`.
    ...
    async def set_photo(
        ...
        *,
        ...
        """Bound method *set_photo* of :obj:`~pixlib.types.Chat`.
        ...
        Parameters:
            photo (``str`` | ``BinaryIO``, *optional*):
                New chat photo. You can pass a :obj:`~pixlib.types.Photo` file_id, a file path to upload a new photo
                from your local machine or a binary file-like object with its attribute
                ".name" set for in-memory uploads.

            video (``str`` | ``BinaryIO``, *optional*):
                New chat video. You can pass a :obj:`~pixlib.types.Video` file_id, a file path to upload a new video
                from your local machine or a binary file-like object with its attribute
                ".name" set for in-memory uploads.
    ...
    async def ban_member(
        ...
        """Bound method *ban_member* of :obj:`~pixlib.types.Chat`.
        ...
        Returns:
            :obj:`~pixlib.types.Message` | ``bool``: On success, a service message will be returned (when applicable), otherwise, in
    ...
    async def unban_member(
        ...
        """Bound method *unban_member* of :obj:`~pixlib.types.Chat`.
    ...
    async def restrict_member(
        ...
        Parameters:
            ...
            permissions (:obj:`~pixlib.types.ChatPermissions`):
        ...
        Returns:
            :obj:`~pixlib.types.Chat`: On success, a chat object is returned.
    ...
    async def promote_member(
        ...
        """Bound method *promote_member* of :obj:`~pixlib.types.Chat`.
        ...
        Parameters:
            ...
            privileges (:obj:`~pixlib.types.ChatPrivileges`, *optional*):
                New user privileges.
    ...
    async def join(self):
        """Bound method *join* of :obj:`~pixlib.types.Chat`.
    ...
    async def leave(self):
        """Bound method *leave* of :obj:`~pixlib.types.Chat`.
    ...
    async def export_invite_link(self):
        """Bound method *export_invite_link* of :obj:`~pixlib.types.Chat`.
    ...
    async def get_member(
        ...
        """Bound method *get_member* of :obj:`~pixlib.types.Chat`.
        ...
        Returns:
            :obj:`~pixlib.types.ChatMember`: On success, a chat member is returned.
        """
    ...
    def get_members(
        ...
        """Bound method *get_members* of :obj:`~pixlib.types.Chat`.
        ...
        Parameters:
            query (``str``, *optional*):
                ...
                A query string is applicable only for :obj:`~pixlib.enums.ChatMembersFilter.SEARCH`,
                :obj:`~pixlib.enums.ChatMembersFilter.BANNED` and :obj:`~pixlib.enums.ChatMembersFilter.RESTRICTED`
                filters only.

            limit (``int``, *optional*):
                Limits the number of members to be retrieved.

            filter (:obj:`~pixlib.enums.ChatMembersFilter`, *optional*):
                Filter used to select the kind of members you want to retrieve. Only applicable for supergroups
                and channels.

        Returns:
            ``Generator``: On success, a generator yielding :obj:`~pixlib.types.ChatMember` objects is returned.
        """
    ...
    async def add_members(
        ...
        """Bound method *add_members* of :obj:`~pixlib.types.Chat`.
    ...
    async def mark_unread(self, ) -> bool:
        """Bound method *mark_unread* of :obj:`~pixlib.types.Chat`.
    ...
    async def set_protected_content(self, enabled: bool) -> bool:
        """Bound method *set_protected_content* of :obj:`~pixlib.types.Chat`.
    ...
    async def unpin_all_messages(self) -> bool:
        """Bound method *unpin_all_messages* of :obj:`~pixlib.types.Chat`.
