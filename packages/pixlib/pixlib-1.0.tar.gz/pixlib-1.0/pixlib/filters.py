...
from pixlib.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "pixlib.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~pixlib.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~pixlib.handlers.MessageHandler` the *update* argument will be a :obj:`~pixlib.types.Message`; in a :obj:`~pixlib.handlers.CallbackQueryHandler` the *update* will be a :obj:`~pixlib.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~pixlib.filters.command` or :meth:`~pixlib.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~pixlib.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~pixlib.types.Document` objects."""
...
"""Filter messages that contain :obj:`~pixlib.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~pixlib.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~pixlib.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~pixlib.types.Game` objects."""
...
"""Filter messages that contain :obj:`~pixlib.types.Video` objects."""
...
"""Filter messages that contain :obj:`~pixlib.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~pixlib.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~pixlib.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~pixlib.types.Location` objects."""
...
"""Filter messages that contain :obj:`~pixlib.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~pixlib.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~pixlib.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~pixlib.types.Message`.
    ...
    async def func(flt, client: pixlib.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~pixlib.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~pixlib.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~pixlib.types.InlineQuery`: The filter will match ``query``.
