...
from pixlib.errors import UnknownError
...
class GetInlineBotResults:
    async def get_inline_bot_results(
        ...
        You can then send a result using :meth:`~pixlib.Client.send_inline_bot_result`
        ...
        Returns:
            :obj:`BotResults <pixlib.api.types.messages.BotResults>`: On Success.
