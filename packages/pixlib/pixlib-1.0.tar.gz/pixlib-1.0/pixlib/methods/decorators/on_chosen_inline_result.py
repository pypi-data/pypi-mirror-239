...
class OnChosenInlineResult:
    def on_chosen_inline_result(
        ...
        :obj:`~pixlib.handlers.ChosenInlineResultHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pixlib.Client):
                self.add_handler(pixlib.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pixlib.handlers.ChosenInlineResultHandler(func, self),
