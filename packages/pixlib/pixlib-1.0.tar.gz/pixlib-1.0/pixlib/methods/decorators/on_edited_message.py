...
class OnEditedMessage:
    def on_edited_message(
        ...
        :obj:`~pixlib.handlers.EditedMessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pixlib.Client):
                self.add_handler(pixlib.handlers.EditedMessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pixlib.handlers.EditedMessageHandler(func, self),
