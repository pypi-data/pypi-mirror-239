...
from pixlib.errors import AuthBytesInvalid
from pixlib.session import Session
from pixlib.session.auth import Auth


async def get_session(client: "pixlib.Client", dc_id: int):
