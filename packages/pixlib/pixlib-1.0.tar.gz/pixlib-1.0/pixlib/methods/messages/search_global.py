...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~pixlib.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~pixlib.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~pixlib.types.Message` objects.
