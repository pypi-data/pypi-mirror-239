...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~pixlib.types.InputMediaPhoto`, :obj:`~pixlib.types.InputMediaVideo`, :obj:`~pixlib.types.InputMediaAudio` and :obj:`~pixlib.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~pixlib.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from pixlib.types import InputMediaPhoto, InputMediaVideo
