...
async def compose(
    ...
    If you want to run a single client, you can use Client's bound method :meth:`~pixlib.Client.run`.

    Parameters:
        clients (List of :obj:`~pixlib.Client`):
    ...
    Example:
        .. code-block:: python
            ...
            import asyncio
            from pixlib import Client, compose
