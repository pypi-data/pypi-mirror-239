...
import pixlib
from pixlib.methods.utilities.idle import idle
...
class Run:
    def run(
        ...
        :meth:`~pixlib.Client.start`, :meth:`~pixlib.idle` and :meth:`~pixlib.Client.stop` in sequence.
        ...
        If you want to run multiple clients at once, see :meth:`pixlib.compose`.
