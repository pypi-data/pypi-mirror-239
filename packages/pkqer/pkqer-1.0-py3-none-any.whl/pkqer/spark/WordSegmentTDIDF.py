...
object WordSegmentTDIDF {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val hashingTF = new HashingTF()
      .setInputCol("context_terms")
      .setOutputCol("context_terms_out")
      .setNumFeatures(2000)
    val featurizedData = hashingTF.transform(termsDF)
    featurizedData.show()
    val idf = new IDF().setInputCol("context_terms_out").setOutputCol("features")
