...
class Integrator:
  ...
  def __init__(
    ...
    system_matrix: numpy.ndarray, # Eigen::MatrixXd
    dt: float, # double

  ) -> any:
    """Creates an integrator able to build expressions and values over a decision variable. A custom continuous system matrix is passed, so that: 
...
class Problem:
  ...
  def add_constraints(
    self: Problem,
    constraints: ProblemConstraint, # placo::problem::ProblemConstraint
...
class ProblemConstraints:
  """This is a simple wrapper that allow to regroup multiple constraints in a vector and configure them all at once. """
  def __init__(
...
class vector_ProblemConstraint:
  def __init__(
    arg1: object,
