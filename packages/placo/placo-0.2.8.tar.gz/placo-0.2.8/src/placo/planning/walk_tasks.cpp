...
void WalkTasks::update_com_task()
{
  if (trunk_mode)
  {
    ...
    if (trunk_task == nullptr)
    {
      ...
      trunk_task->configure("trunk", "scaled", 1.);
    }
  }
  else
  {
    ...
    if (com_task == nullptr)
    {
      ...
      com_task->configure("com", "scaled", 1.);
    }
  }
}
...
kinematics::CoMTask& WalkTasks::get_com_task()
{
  return *com_task;
}
