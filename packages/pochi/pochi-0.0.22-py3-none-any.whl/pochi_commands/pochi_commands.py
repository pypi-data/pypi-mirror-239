        ...
        if snowcli_config_toml is not None and os.path.exists(snowcli_config_toml):
            ...
            if connection_config.has_section(connection_section_name):
                ...
                setattr(
                    connection_config_namespace,
                    "account",
                    default_connection_config.get("accountname", None),
                )
                setattr(
                    connection_config_namespace,
                    "user",
                    default_connection_config.get("username", None),
                )
                setattr(
                    connection_config_namespace,
                    "password",
                    default_connection_config.get("password", None),
                )
                setattr(
                    connection_config_namespace,
                    "role",
                    default_connection_config.get("rolename", None),
                )
                setattr(
                    connection_config_namespace,
                    "warehouse",
                    default_connection_config.get("warehousename", None),
                )
                setattr(
                    connection_config_namespace,
                    "private_key_path",
                    default_connection_config.get("private_key_path", None),
                )
