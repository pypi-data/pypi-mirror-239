...
class AnsibleGitRemote(object):
    ...
    def __init__(self, ca_cert=None, url=None, tls_validation=None, sock_read_timeout=None, max_retries=None, name=None, headers=None, username=None, proxy_password=None, rate_limit=None, password=None, client_cert=None, sock_connect_timeout=None, client_key=None, connect_timeout=None, total_timeout=None, proxy_username=None, pulp_labels=None, proxy_url=None, download_concurrency=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
