...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, ca_cert=None, pulp_last_updated=None, url=None, tls_validation=None, pulp_href=None, sock_read_timeout=None, pulp_created=None, max_retries=None, name=None, headers=None, rate_limit=None, client_cert=None, sock_connect_timeout=None, hidden_fields=None, connect_timeout=None, total_timeout=None, pulp_labels=None, proxy_url=None, download_concurrency=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
