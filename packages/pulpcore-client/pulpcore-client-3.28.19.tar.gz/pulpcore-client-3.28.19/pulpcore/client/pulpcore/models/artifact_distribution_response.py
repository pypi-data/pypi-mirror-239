...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_path=None, name=None, pulp_labels=None, pulp_created=None, content_guard=None, pulp_href=None, hidden=False, base_url=None, local_vars_configuration=None):  # noqa: E501
