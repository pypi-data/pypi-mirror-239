...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, base_url=None, content_guard=None, hidden=False, pulp_labels=None, pulp_href=None, name=None, base_path=None, local_vars_configuration=None):  # noqa: E501
