...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_labels=None, base_url=None, hidden=False, pulp_href=None, pulp_created=None, base_path=None, content_guard=None, name=None, local_vars_configuration=None):  # noqa: E501
