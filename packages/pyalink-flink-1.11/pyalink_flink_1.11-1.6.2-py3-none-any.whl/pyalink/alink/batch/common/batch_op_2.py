...
class C45EncoderTrainBatchOp(BatchOperator, WithModelInfoBatchOp):
    CLS_NAME = 'com.alibaba.alink.operator.batch.feature.C45EncoderTrainBatchOp'
    OP_TYPE = 'FUNCTION'

    def __init__(self, *args, **kwargs):
        kwargs['CLS_NAME'] = self.CLS_NAME
        kwargs['OP_TYPE'] = self.OP_TYPE
        super(C45EncoderTrainBatchOp, self).__init__(*args, **kwargs)
        pass
...
class CartEncoderTrainBatchOp(BatchOperator, WithModelInfoBatchOp):
    CLS_NAME = 'com.alibaba.alink.operator.batch.feature.CartEncoderTrainBatchOp'
    OP_TYPE = 'FUNCTION'

    def __init__(self, *args, **kwargs):
        kwargs['CLS_NAME'] = self.CLS_NAME
        kwargs['OP_TYPE'] = self.OP_TYPE
        super(CartEncoderTrainBatchOp, self).__init__(*args, **kwargs)
        pass
...
class CartRegEncoderTrainBatchOp(BatchOperator, WithModelInfoBatchOp):
    CLS_NAME = 'com.alibaba.alink.operator.batch.feature.CartRegEncoderTrainBatchOp'
    OP_TYPE = 'FUNCTION'

    def __init__(self, *args, **kwargs):
        kwargs['CLS_NAME'] = self.CLS_NAME
        kwargs['OP_TYPE'] = self.OP_TYPE
        super(CartRegEncoderTrainBatchOp, self).__init__(*args, **kwargs)
        pass
...
class ConstrainedBinarySelectorPredictBatchOp(BatchOperator):
    CLS_NAME = 'com.alibaba.alink.operator.batch.finance.ConstrainedBinarySelectorPredictBatchOp'
    OP_TYPE = 'FUNCTION'

    def __init__(self, *args, **kwargs):
        kwargs['CLS_NAME'] = self.CLS_NAME
        kwargs['OP_TYPE'] = self.OP_TYPE
        super(ConstrainedBinarySelectorPredictBatchOp, self).__init__(*args, **kwargs)
        pass
...
class ConstrainedBinarySelectorTrainBatchOp(BatchOperator):
    CLS_NAME = 'com.alibaba.alink.operator.batch.finance.ConstrainedBinarySelectorTrainBatchOp'
    OP_TYPE = 'FUNCTION'

    def __init__(self, *args, **kwargs):
        kwargs['CLS_NAME'] = self.CLS_NAME
        kwargs['OP_TYPE'] = self.OP_TYPE
        super(ConstrainedBinarySelectorTrainBatchOp, self).__init__(*args, **kwargs)
        pass
...
class ConstrainedDivergenceTrainBatchOp(BatchOperator):
    CLS_NAME = 'com.alibaba.alink.operator.batch.finance.ConstrainedDivergenceTrainBatchOp'
    OP_TYPE = 'FUNCTION'

    def __init__(self, *args, **kwargs):
        kwargs['CLS_NAME'] = self.CLS_NAME
        kwargs['OP_TYPE'] = self.OP_TYPE
        super(ConstrainedDivergenceTrainBatchOp, self).__init__(*args, **kwargs)
        pass
    ...
    def setConstraint(self, val):
        return self._add_param('constraint', val)
...
class ConstrainedLinearRegTrainBatchOp(BatchOperator):
    CLS_NAME = 'com.alibaba.alink.operator.batch.finance.ConstrainedLinearRegTrainBatchOp'
    OP_TYPE = 'FUNCTION'

    def __init__(self, *args, **kwargs):
        kwargs['CLS_NAME'] = self.CLS_NAME
        kwargs['OP_TYPE'] = self.OP_TYPE
        super(ConstrainedLinearRegTrainBatchOp, self).__init__(*args, **kwargs)
        pass
...
class ConstrainedLogisticRegressionTrainBatchOp(BatchOperator):
    CLS_NAME = 'com.alibaba.alink.operator.batch.finance.ConstrainedLogisticRegressionTrainBatchOp'
    OP_TYPE = 'FUNCTION'

    def __init__(self, *args, **kwargs):
        kwargs['CLS_NAME'] = self.CLS_NAME
        kwargs['OP_TYPE'] = self.OP_TYPE
        super(ConstrainedLogisticRegressionTrainBatchOp, self).__init__(*args, **kwargs)
        pass
...
class ConstrainedRegSelectorPredictBatchOp(BatchOperator):
    CLS_NAME = 'com.alibaba.alink.operator.batch.finance.ConstrainedRegSelectorPredictBatchOp'
    OP_TYPE = 'FUNCTION'

    def __init__(self, *args, **kwargs):
        kwargs['CLS_NAME'] = self.CLS_NAME
        kwargs['OP_TYPE'] = self.OP_TYPE
        super(ConstrainedRegSelectorPredictBatchOp, self).__init__(*args, **kwargs)
        pass
...
class ConstrainedRegSelectorTrainBatchOp(BatchOperator):
    CLS_NAME = 'com.alibaba.alink.operator.batch.finance.ConstrainedRegSelectorTrainBatchOp'
    OP_TYPE = 'FUNCTION'

    def __init__(self, *args, **kwargs):
        kwargs['CLS_NAME'] = self.CLS_NAME
        kwargs['OP_TYPE'] = self.OP_TYPE
        super(ConstrainedRegSelectorTrainBatchOp, self).__init__(*args, **kwargs)
        pass
...
class CrossCandidateSelectorPredictBatchOp(BatchOperator):
    CLS_NAME = 'com.alibaba.alink.operator.batch.feature.CrossCandidateSelectorPredictBatchOp'
    OP_TYPE = 'FUNCTION'

    def __init__(self, *args, **kwargs):
        kwargs['CLS_NAME'] = self.CLS_NAME
        kwargs['OP_TYPE'] = self.OP_TYPE
        super(CrossCandidateSelectorPredictBatchOp, self).__init__(*args, **kwargs)
        pass
...
class CrossCandidateSelectorTrainBatchOp(BatchOperator):
    CLS_NAME = 'com.alibaba.alink.operator.batch.feature.CrossCandidateSelectorTrainBatchOp'
    OP_TYPE = 'FUNCTION'

    def __init__(self, *args, **kwargs):
        kwargs['CLS_NAME'] = self.CLS_NAME
        kwargs['OP_TYPE'] = self.OP_TYPE
        super(CrossCandidateSelectorTrainBatchOp, self).__init__(*args, **kwargs)
        pass
