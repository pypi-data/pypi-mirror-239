...
from qualtop_llmapi.models import mistral
...
async def chat_completion(request: ChatCompletionRequest):
    ...
    if model_name == "mistral-7b-instruct-v0.1.Q4_0.gguf":
        answer = mistral.ask(formatted_messages)
    else:
    ...
    # Get measures
    prompt_tokens = count(formatted_messages.format())
    completion_tokens = count("Assistant: " + answer)
