...
from quokka_web.page_interactor.modules.option_handler import OptionHandler
...
class PageInteractor:
    def __init__(self, page, debug_tool: Optional[Debugger] = None):
        ...
        self._option_handler = OptionHandler(page=self.page, debug_tool=self.debug_tool)
    ...
    async def select_option(self, scroll_down_sel: str, value: str, **kwargs):
        ...
        :return:
        """
        return await self._option_handler.select_option(scroll_down_sel=scroll_down_sel, value=value, **kwargs)
