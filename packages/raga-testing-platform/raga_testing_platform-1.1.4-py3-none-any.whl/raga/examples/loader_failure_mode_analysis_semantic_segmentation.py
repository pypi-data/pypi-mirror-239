...
def csv_parser(csv_path):
    data_frame = pd.read_csv(csv_path).head(100)
    ...
    data_frame["ImageEmbedding"] = data_frame['ImageVectorsM1'].apply(lambda x:replace_embedding(x))
    return data_frame
...
test_ds = Dataset(test_session=test_session,
                  name="satellite_image_dataset_3_nov_v1",
