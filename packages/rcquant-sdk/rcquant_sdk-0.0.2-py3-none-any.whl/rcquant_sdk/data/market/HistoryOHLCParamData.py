...
class HistoryOHLCParamData(IData):
    def __init__(self, marketname: str = '', exchangeid: str = '', instrumentid: str = '', range: str = "60", startdate: str = '', enddate: str = '', ohlclist: List[OHLCData] = []):
        ...
        self._OHLCList: List[OHLCData] = ohlclist
