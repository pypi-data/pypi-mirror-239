...
class ValidateRequestInput(object):
    ...
    def user_input_text(self):
        ...
        Input text is the raw user input. The generative firewall performs validation on input to prevent risk such as prompt injection or prompt extraction.  # noqa: E501
