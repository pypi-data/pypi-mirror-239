...
class SendableBuilder:
    ...
    def addIntegerProperty(self, key: str, getter: typing.Callable[[], int], setter: typing.Callable[[int], None]) -> None:
        ...
        :param setter: setter function (sets new value)
        """
    def addRawProperty(self, key: str, typeString: str, getter: typing.Callable[[], list[int]], setter: typing.Callable[[Buffer], None]) -> None:
        """
        Add a raw property.
    ...
    def addSmallIntegerArrayProperty(self, key: str, getter: typing.Callable[[List[int]], list[int]], setter: typing.Callable[[List[int]], None]) -> None:
        ...
        :param setter: setter function (sets new value)
        """
    def addSmallRawProperty(self, key: str, typeString: str, getter: typing.Callable[[List[int]], typing_extensions.Buffer], setter: typing.Callable[[Buffer], None]) -> None:
        """
