...
from .gadgets.models import users, chats, extras, groups, messages
...
class Client:
    ...
    async def get_me(self, *args, **kwargs) -> users.GetUserInfo:
        result = await self(methods.users.GetUserInfo(self._guid, *args, **kwargs))
...
# ---------------- Messages Methods ----------------
    ...
    async def send_message(self,
                           ...
                           thumb: bool = True, *args, **kwargs) -> messages.SendMessage:
        """_send message_
    ...
    async def send_photo(self, object_guid: str, photo: bytes, caption: str = None, reply_to_message_id: str = None, *args, **kwargs) -> messages.SendMessage:
        """
        Send a photo.
    ...
    async def send_document(self, object_guid: str, document: bytes, caption: str = None, reply_to_message_id: str = None, *args, **kwargs) -> messages.SendMessage:
        """
        Send a document.
    ...
    async def send_gif(self, object_guid: str, gif: bytes, caption: str = None, reply_to_message_id: str = None, *args, **kwargs) -> messages.SendMessage:
        """
        Send a GIF.
    ...
    async def send_video(self, object_guid: str, video: bytes, caption: str = None, reply_to_message_id: str = None, *args, **kwargs) -> messages.SendMessage:
        """
        Send a video.
    ...
    async def send_music(self, object_guid: str, music: bytes, caption: str = None, reply_to_message_id: str = None, *args, **kwargs) -> messages.SendMessage:
        """
        Send music.
    ...
    async def send_voice(self, object_guid: str, voice: bytes, caption: str = None, reply_to_message_id: str = None, *args, **kwargs) -> messages.SendMessage:
        """
