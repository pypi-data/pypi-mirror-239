...
class CLIWrapper:
    ...
    def __init__(self):
        ...
        sub_command.add_argument("--distr-bs", help='(Dev) distrb bdev block size, default: 4096', type=int, default=4096)
        ...
        if args.command in ['storage-node', 'sn']:
            ...
            if sub_command == "deploy":
                ...
                out = storage_ops.add_node(
                    cluster_id, node_ip, ifname, data_nics, spdk_cpu_mask, spdk_mem, dev_split, spdk_image)
                return out
