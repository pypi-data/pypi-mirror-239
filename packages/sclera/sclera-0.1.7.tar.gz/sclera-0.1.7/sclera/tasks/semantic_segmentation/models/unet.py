...
class UNet(keras.models.Model):
    ...
    Args:
        ...
        filters: The number of filters to use in the first layer of the
            ...
            part of the U-Net.
        num_classes: The number of classes to predict. This will be the
            number of channels in the output mask of the U-Net.
    ...
    Example Usage:
        ...
        model = Unet(depth=depth, num_classes=10, filters=filters, activation=activation, input_shape=input_shape)
        ```
    """
    ...
    def __init__(
        ...
        # Output
        output_layer = keras.layers.Conv2D(num_classes, 1, activation="sigmoid")(x)
