...
def connection_db(url):
    try:
        print(url, os.environ.get('SQLALCHEMY_DATABASE_URI'), "test")
...
def parse_data():
    ...
    parser.add_argument('--db_uri', required=True, help="enter your db")

    command_line_args = parser.parse_args()
    connection = connection_db(command_line_args.db_uri)
