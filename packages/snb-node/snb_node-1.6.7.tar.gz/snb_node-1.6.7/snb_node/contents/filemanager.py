...
from snb_node.tools.utils import exists
...
from ..tools import tz as tz
from snb_node.tools.utils import (
    is_hidden, is_file_hidden,
    to_api_path,
)
from snb_node.base.handlers import AuthenticatedFileHandler
from snb_node.tools.transutils import _
...
class FileContentsManager(FileManagerMixin, ContentsManager):
    ...
    def _base_model(self, path):
        ...
        if path.startswith("home/"):
            ...
            model['file_path'] = "/home/" + path
        model['update_time'] = last_modified
    ...
    def _dir_model(self, path, content=True):
        ...
        if content:
            ...
            contents=sorted(contents, key=lambda con: con['type'], reverse=True)
            model['content'] = contents
            model['format'] = 'json'
    ...
    def rename_file(self, old_path, new_path):
        ...
        if (is_hidden(old_path, self.root_dir) or is_hidden(new_path, self.root_dir)) and not self.allow_hidden:
            raise web.HTTPError(400, f'Cannot rename file or directory {old_path}')
