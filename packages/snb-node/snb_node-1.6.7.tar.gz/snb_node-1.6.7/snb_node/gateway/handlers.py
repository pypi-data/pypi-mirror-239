...
from snb_node.base.handlers import APIHandler, IPythonHandler
from snb_node.tools.utils import url_path_join
...
from snb_node.kernels.handlers import _kernel_id_regex

default_handlers = [
    (fr"/api/snb/node/kernels/{_kernel_id_regex}/channels", WebSocketChannelsHandler),
]
