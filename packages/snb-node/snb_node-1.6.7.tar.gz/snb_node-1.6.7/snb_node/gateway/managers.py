...
from snb_node.kernels.kernelmanager import AsyncMappingKernelManager
...
class GatewayClient(SingletonConfigurable):
    ...
    kernels_endpoint_default_value = '/api/snb/node/kernels'
    ...
    kernelspecs_endpoint_default_value = '/api/snb/node/kernelspecs'
