...
def maybe_future(obj):
    """
    就像tornado的废弃gen.maybe_future，但在最近的版本中与asyncio更兼容的版本。
    :param obj:
    :return:
    """
    # isawaitable(obj).如果对象可以用在await表达式中，则返回True。可用于区分基于生成器的协程和常规生成器
...
def url_path_join(*pieces):
    """
    desc: 将url的组件连接为相对url.
    用于连接子路径时避免使用双斜杠。这样就会留下初始和最终/到位
    """
