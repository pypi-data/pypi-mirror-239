    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            if step != "training_data" and config_manager.get('global', 'api_key') is None:
                ...
                click.echo("To learn how to get your Spectral API Key, please visit https://spectral.gitbook.io/spectral-new/modeler-handbook/2.-model-training/step-3-configure-spectral-cli#obtain-alchemy-api-key.")
            ...
            if config_manager.get('global', 'alchemy_api_key') is None:
                ...
                click.echo(
                    "To learn how to get your Alchemy API Key, please visit https://spectral.gitbook.io/spectral-new/modeler-handbook/2.-model-training/step-3-configure-spectral-cli#obtain-alchemy-api-key.")
...
def show_wallet():
    ...
    if wallet_address:
        print(f"Spectral CLI wallet address: {wallet_address}")
    else:
