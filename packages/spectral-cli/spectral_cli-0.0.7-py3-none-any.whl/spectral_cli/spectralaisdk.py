...
def ensure_global_config(step=None):
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            if step != "testing_data" and config_manager.get('global', 'api_key') is None:
            ...
            if config_manager.get('global', 'wallet_private_key') is None and config_manager.get('global', 'wallet_address') is None:
                ...
                config_updated = True
            if step != "testing_data" and config_manager.get('global', 'wallet_private_key') and config_manager.get('global', 'multisig_wallet_address') is None and not config_updated:
...
@cli.command()
@ensure_global_config("testing_data")
