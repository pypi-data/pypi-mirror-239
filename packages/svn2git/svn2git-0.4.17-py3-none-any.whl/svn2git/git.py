...
class GitMigrationHelper:
    ...
    def __init__(
        self, svn_remote_prefix: str = "svn", initial_branch_name: str = "main", cwd: Optional[str] = None
    ) -> None:
    ...
    def fix_branches(self, branches: GitBranches, rebase: bool = False, trunk_branch: str = "trunk") -> None:
        ...
        for svn_branch in svn_branches:
            ...
            if rebase and (branch in branches.locals or branch == trunk_branch):
                ...
                run_command(f'git rebase "remotes/{self._svn_remote_prefix}/{local_branch}', cwd=self._cwd)
                continue
    ...
    def checkout_svn_branch(self, branch: str) -> None:
        ...
        run_command(
            ["sh", "-c", f'\'git checkout -b "{branch}" "remotes/{self._svn_remote_prefix}/{branch}"\''], cwd=self._cwd
        )
