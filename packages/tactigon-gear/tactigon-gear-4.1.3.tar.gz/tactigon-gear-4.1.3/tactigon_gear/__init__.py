...
from .models import TBleSelector, Gesture, Button, Angle, Acceleration, Gyro, TSkinState, TSkinConfig
...
class TSkin:
    ...
    def __init__(self,
        ...
        self.BLE = BLE(self.config.name, self.config.address, self.logger, self.sensor_tx, None, None, self.adpcm_tx)
