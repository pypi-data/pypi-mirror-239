...
class MaterializedFeatureView(FeatureView):
    ...
    @sdk_decorators.sdk_public_method(
        ...
        supports_skip_validation=(ComputeMode.SPARK, ComputeMode.TECTON_BATCH),
    )
    ...
    def aggregations(self) -> Optional[configs.Aggregation]:
        ...
        for agg in aggregate_features:
            time_window = create_time_window_spec_from_data_proto(agg.time_window)
...
def _build_materialized_feature_view_args(
    ...
    if tecton_runtime_version is None:
        # temporary placeholder, should be filled by repo config for 0.8+ and stays as null otherwise
        tecton_runtime_version = "0.8.0b24"
