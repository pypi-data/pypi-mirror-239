...
@attrs.define(auto_attribs=True)
class TectonBatchComputeConfig:
    """Configuration used to specify materialization cluster options on Tecton Compute cluster.
    ...
    def _to_proto(self) -> feature_view_pb2.TectonBatchComputeClusterConfig:
        proto = feature_view_pb2.TectonBatchComputeClusterConfig()
        if self.instance_type:
            proto.instance_type = self.instance_type
    ...
    def _to_cluster_proto(self) -> feature_view_pb2.ClusterConfig:
        return feature_view_pb2.ClusterConfig(tecton_batch_compute=self._to_proto())
