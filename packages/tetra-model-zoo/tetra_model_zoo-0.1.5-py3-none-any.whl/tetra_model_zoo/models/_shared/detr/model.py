...
from tetra_model_zoo.utils.zoo_base_class import DEFAULT_EXPORT_DEVICES, TetraZooModel

MODEL_ID = __name__.split(".")[-2]
MODEL_ASSET_VERSION = 1


class DETR(TetraZooModel):
    ...
    def export(
        ...
        return super().export(input_spec, devices, "--enable_mlpackage")
    ...
    def get_input_spec(
        ...
        """
        return {
            "image": ((batch_size, num_channels, x, y), "float32"),
            "mask": ((batch_size, x, y), "float32"),
        }
