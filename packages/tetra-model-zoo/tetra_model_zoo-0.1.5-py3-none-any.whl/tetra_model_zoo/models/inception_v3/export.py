...
from tetra_model_zoo.models.inception_v3.model import InceptionNetV3
...
def main():
    # Export parameters
    parser = base_export_parser(model_cls=InceptionNetV3)
    args = parser.parse_args()

    # Instantiate the model
    model = model_from_cli_args(InceptionNetV3, args)
