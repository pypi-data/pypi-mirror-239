...
from tetra_model_zoo.models.lama_dilated.model import LamaDilated
...
def main(is_test: bool = False):
    # Export parameters
    parser = base_export_parser(model_cls=LamaDilated)
    args = parser.parse_args([] if is_test else None)

    # Instantiate the model & a sample input.
    model = model_from_cli_args(LamaDilated, args)
