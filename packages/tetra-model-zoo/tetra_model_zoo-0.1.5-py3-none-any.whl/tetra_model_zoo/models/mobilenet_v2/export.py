...
from tetra_model_zoo.models.mobilenet_v2.model import MobileNetV2
...
def main():
    # Export parameters
    parser = base_export_parser(model_cls=MobileNetV2)
    args = parser.parse_args()

    # Instantiate the model
    model = model_from_cli_args(MobileNetV2, args)
