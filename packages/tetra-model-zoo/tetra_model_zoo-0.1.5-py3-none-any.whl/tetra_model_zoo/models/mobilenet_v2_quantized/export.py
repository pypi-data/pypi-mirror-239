...
from tetra_model_zoo.models.mobilenet_v2_quantized.model import MobileNetV2Quantized
...
def main():
    # Export parameters
    parser = base_export_parser(model_cls=MobileNetV2Quantized)
    args = parser.parse_args()

    # Instantiate the model
    model = model_from_cli_args(MobileNetV2Quantized, args)
