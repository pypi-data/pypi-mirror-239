...
from tetra_model_zoo.models.mobilenet_v3_large.model import MobileNetV3Large
...
def main():
    # Export parameters
    parser = base_export_parser(model_cls=MobileNetV3Large)
    args = parser.parse_args()

    # Instantiate the model
    model = model_from_cli_args(MobileNetV3Large, args)
