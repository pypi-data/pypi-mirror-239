...
from tetra_model_zoo.models.mobilenet_v3_small.model import MobileNetV3Small
...
def main():
    # Export parameters
    parser = base_export_parser(model_cls=MobileNetV3Small)
    args = parser.parse_args()

    # Instantiate the model
    model = model_from_cli_args(MobileNetV3Small, args)
