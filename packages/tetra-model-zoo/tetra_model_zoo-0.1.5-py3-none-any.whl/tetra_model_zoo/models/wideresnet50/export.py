...
from tetra_model_zoo.models.wideresnet50.model import WideResNet50
...
def main():
    # Export parameters
    parser = base_export_parser(model_cls=WideResNet50)
    args = parser.parse_args()

    # Instantiate the model
    model = model_from_cli_args(WideResNet50, args)
