...
class ValidatedMixin:
    ...
    def __init__(self, *args, error_var=None, **kwargs):
        ...
        '''
        @Author ：yb
        @Date   ：2023-08-19 21:50:10
        @Desc   ：
        we need to give it a tuple containing a reference to a Tcl/Tk function, 
        and optionally some substitution codes that specify information
        '''
        self.config(
            validate='all',
