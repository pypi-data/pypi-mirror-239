...
class BackendConfigurationPage(ConfigurationPage):
    def __init__(self, master):
        ...
        # 监听下拉框值的变化事件，当选择的解释器发生改变时调用_backend_changed函数
...
def load_plugin() -> None:
    ...
    # 添加下拉菜单 配置解释器 Configure interpreter
