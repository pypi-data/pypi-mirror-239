from tkadw.designer.designerframe import AdwDesignerFrame, Dndr as PythonistDndr
...
class AdwDesigner(Adwite):
    ...
    def setup_project_panel(self):
        ...
        self.project_panel = AdwTListBox(self, width=130, item_selected=selection)
    ...
    def setup_widgets_panel(self):
        ...
        self.widgets_panel = AdwTListBox(self, items=["AdwTButton", "AdwTEntry", "AdwTText"], width=130)
    ...
    def setup_designer_panel(self):
        ...
        self.designer_panel = AdwTMDI(self)
...
if __name__ == '__main__':
    from tkadw import *
    root = AdwDesigner(default_theme="metro")
