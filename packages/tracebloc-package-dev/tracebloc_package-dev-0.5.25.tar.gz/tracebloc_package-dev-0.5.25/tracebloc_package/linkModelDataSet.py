        ...
        if self.__framework == TENSORFLOW_FRAMEWORK:
            ...
            if type(batchSize) == int:
                if images // batchSize < 3:
                    ...
                    error_msg = "Please choose batch size greater than num of classes in dataset provided\n"
                    self.__print_error(error_msg)
                    return
                elif batchSize > 128:
                    error_msg = "Please choose batch size less than 128\n"
                    self.__print_error(error_msg)
                    return
        ...
        if self.__framework == TENSORFLOW_FRAMEWORK:
            ...
            if (
                ...
                try:
                    ...
                    error_msg = f"Please provide pytorch supported default loss functions losses: {l}\n"
                    self.__print_error(error_msg)
            else:
