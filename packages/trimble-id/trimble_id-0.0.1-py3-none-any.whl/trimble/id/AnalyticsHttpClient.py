...
class AnalyticsHttpClient:
    ...
    @staticmethod
    def SendInitEvent(name, client_name = None, client_version = None, application_id = None, cid = None):
        """
        ...
        AnalyticsHttpClient.SendEvent(name, params, cid)

    @staticmethod
    def SendMethodEvent(name, client_name = None, client_version = None, application_id = None, cid = None):
        """
        Send method events
    ...
    @staticmethod
    def SendEvent(name, params, cid=None):
        """
