...
class ClientCredentialTokenProvider:
    ...
    def __init__(self, endpointProvider, consumerKey, consumerSecret, productName=None):
        ...
        AnalyticsHttpClient.SendInitEvent(
            name=self.__class__.__name__ + '_init', 
    ...
    async def retrieve_token(self):
        ...
        """
        AnalyticsHttpClient.SendMethodEvent(name="retrieve_token_method", client_name=PACKAGE_NAME, client_version=self._version, application_id=self._consumerKey)
