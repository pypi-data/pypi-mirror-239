...
class K8Connector(ConnectorInterface):
    ...
    def get_handle(self, data):
        try:
            ...
            k8Credential = K8Schema(kubeconfig="")

        # If the kubeconfig is not empty, use the kubeconfig.
        # If kubeconfig is empty, use the incluster config
        if k8Credential.kubeconfig != "":
