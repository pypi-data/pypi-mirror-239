...
from videoembed.providers.base import TRequestParams, TOEmbedData, TThumbnailData
from videoembed.providers.youtube import YoutubeProvider


class TestYoutubeProvider(TestCase):
    ...
    def setUp(self):
        self.config = {}
        self.video_id = '_YUugB4IUl4'
        self.video_url = f'https://www.youtube.com/watch?v={self.video_id}'
        self.provider = YoutubeProvider(self.video_url, self.config)

    def test___init___default_config(self):
        # do it
        provider = YoutubeProvider(self.video_url, self.config)
    ...
    def test___init___custom_config(self):
        ...
        provider = YoutubeProvider(self.video_url, config)
    ...
    def test_make_request__success(self):
        ...
        self.assertEqual(result.keys(), set(TOEmbedData.__annotations__.keys()))
