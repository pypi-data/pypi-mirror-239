...
def get_latest_timestamp_for_index_prices(
    underlying: str, engine=DataBaseConnection().alchemy_engine
) -> datetime | None:
...
def get_fresh_index_prices(
    underlying: str,
    engine=DataBaseConnection().alchemy_engine,
) -> pd.DataFrame:
    ...
    last_timestamp = get_latest_timestamp_for_index_prices(underlying, engine)
...
def upload_index_prices_to_database(
    ...
    df = get_fresh_index_prices(underlying, engine)
