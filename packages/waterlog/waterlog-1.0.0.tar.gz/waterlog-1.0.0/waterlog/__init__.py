...
handlers = log_manager.handlers
setup = log_manager.setup
add_handler = log_manager.add_handler
add_special_handler = log_manager.add_special_handler
set_format = log_manager.set_format
set_level = log_manager.set_level
get = log_manager.get
