...
class CommitScheduler:
    ...
    triggered. Checkout the [upload guide](https://wow-ai.net/docs/wow_ai_hub/guides/upload#scheduled-uploads)
    ...
    ```py
    >>> from pathlib import Path
    >>> from wow_ai_hub import CommitScheduler
    ...
    def push_to_hub(self) -> Optional[CommitInfo]:
        ...
        out our [integration guide](https://wow-ai.net/docs/wow_ai_hub/main/en/guides/upload#scheduled-uploads).
        """
