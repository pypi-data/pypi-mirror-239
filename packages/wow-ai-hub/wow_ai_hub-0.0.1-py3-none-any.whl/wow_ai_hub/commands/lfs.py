...
path = /path/to/wow_ai_hub/.env/bin/python args = -m debugpy --listen 5678
--wait-for-client
/path/to/wow_ai_hub/src/wow_ai_hub/commands/huggingface_cli.py
...
from wow_ai_hub.lfs import LFS_MULTIPART_UPLOAD_COMMAND, SliceFileObj
