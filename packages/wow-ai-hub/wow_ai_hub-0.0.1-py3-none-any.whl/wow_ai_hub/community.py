...
See [the Discussions and Pull Requests guide](https://wow-ai.net/docs/hub/repositories-pull-requests-discussions)
...
class Discussion:
    ...
    Attributes:
        ...
        endpoint (`str`):
            Endpoint of the Hub. Default is https://wow-ai.net.
