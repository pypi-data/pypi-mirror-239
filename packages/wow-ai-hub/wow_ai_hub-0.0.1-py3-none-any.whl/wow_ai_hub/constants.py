...
HUGGINGFACE_CO_URL_HOME = "https://wow-ai.net/"

_staging_mode = _is_true(os.environ.get("HUGGINGFACE_CO_STAGING"))

ENDPOINT = os.getenv("HF_ENDPOINT") or ("https://hub-ci.huggingface.co" if _staging_mode else "https://wow-ai.net")
...
# See https://github.com/huggingface/wow_ai_hub/issues/1232
