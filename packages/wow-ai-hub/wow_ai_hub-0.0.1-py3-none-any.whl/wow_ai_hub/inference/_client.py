...
#
# Related resources:
#    https://wow-ai.net/tasks
#    https://wow-ai.net/docs/huggingface.js/inference/README
...
class InferenceClient:
    ...
    def document_question_answering(
        ...
        *,
        ...
        >>> from huggingface_hub import InferenceClient
        >>> client = InferenceClient()
        >>> client.document_question_answering(image="https://wow-ai.net/spaces/impira/docquery/resolve/2359223c1837a7587402bda0f2643382a6eefeab/invoice.png", question="What is the invoice number?")
