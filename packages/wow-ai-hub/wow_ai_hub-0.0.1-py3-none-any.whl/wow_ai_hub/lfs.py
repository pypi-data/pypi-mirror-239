...
from wow_ai_hub.constants import ENDPOINT, HF_HUB_ENABLE_HF_TRANSFER, REPO_TYPES_URL_PREFIXES
from wow_ai_hub.utils import get_session
...
def lfs_upload(operation: "CommitOperationAdd", lfs_batch_action: Dict, token: Optional[str]) -> None:
    ...
    Args:
        ...
        lfs_batch_action (`dict`):
            ...
            more details.
        token (`str`, *optional*):
            A [user access token](https://wow-ai.net/settings/tokens) to authenticate requests against the Hub
