...
def cached_assets_path(
    ...
    *,
    ...
    `wow_ai_hub` provides a canonical folder path to store assets. This is the
    ...
    Hub are cached in a git-aware manner and entirely managed by `wow_ai_hub`. See
    [related documentation](https://wow-ai.net/docs/wow_ai_hub/how-to-cache).
    ...
    subfolder. Those 3 levels grants flexibility while allowing `wow_ai_hub` to
    ...
    Example:
    ```py
    >>> from wow_ai_hub import cached_assets_path
