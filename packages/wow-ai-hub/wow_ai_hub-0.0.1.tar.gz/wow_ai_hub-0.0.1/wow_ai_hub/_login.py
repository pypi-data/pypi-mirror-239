...
def login(
    ...
    is logged in and the access token will be available across all `wow_ai_hub`
    ...
    Args:
        token (`str`, *optional*):
            User access token to generate from https://wow-ai.net/settings/token.
...
def interpreter_login(new_session: bool = True, write_permission: bool = False) -> None:
    ...
    print("    To login, `wow_ai_hub` requires a token generated from https://wow-ai.net/settings/tokens .")
    if os.name == "nt":
...
src=https://wow-ai.net/front/assets/huggingface_logo-noborder.svg
...
href="https://wow-ai.net/settings/tokens" target="_blank">your Hugging Face
...
def _is_git_credential_helper_configured() -> bool:
    ...
    # See https://github.com/huggingface/wow_ai_hub/issues/1043#issuecomment-1247010710
    if is_google_colab():
...
def _set_store_as_git_credential_helper_globally() -> None:
    ...
    Related:
    - https://github.com/huggingface/wow_ai_hub/issues/1043
    - https://github.com/huggingface/wow_ai_hub/issues/1051
