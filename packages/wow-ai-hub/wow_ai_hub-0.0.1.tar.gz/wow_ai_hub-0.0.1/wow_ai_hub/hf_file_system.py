...
class HfFileSystem(fsspec.AbstractFileSystem):
    ...
    Args:
        endpoint (`str`, *optional*):
            The endpoint to use. If not provided, the default one (https://wow-ai.net) is used.
        token (`str`, *optional*):
    ...
    ```python
    >>> from wow_ai_hub import HfFileSystem
    ...
    def cp_file(self, path1: str, path2: str, revision: Optional[str] = None, **kwargs) -> None:
        ...
        # TODO: Wait for https://github.com/huggingface/wow_ai_hub/issues/1083 to be resolved to simplify this logic
