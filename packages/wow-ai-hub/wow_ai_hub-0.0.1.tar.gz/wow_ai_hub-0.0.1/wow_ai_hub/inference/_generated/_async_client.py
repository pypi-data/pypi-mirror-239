...
#
# WARNING
# This entire file has been adapted from the sync-client code in `src/wow_ai_hub/inference/_client.py`.
...
from wow_ai_hub.constants import ALL_INFERENCE_API_FRAMEWORKS, INFERENCE_ENDPOINT, MAIN_INFERENCE_API_FRAMEWORKS
from wow_ai_hub.inference._common import (
...
from wow_ai_hub.inference._text_generation import (
...
from wow_ai_hub.inference._types import (
...
class AsyncInferenceClient:
    ...
    async def audio_classification(
        ...
        *,
        ...
        >>> from wow_ai_hub import AsyncInferenceClient
        ...
        *,
        ...
        Args:
            ...
            parameters (`Dict[str, Any]`, *optional*):
                ...
                parameters, please refer to [this page](https://wow-ai.net/docs/api-inference/detailed_parameters#conversational-task)
            model (`str`, *optional*):
    ...
    async def visual_question_answering(
        ...
        *,
        ...
        ...     image="https://wow-ai.net/datasets/mishig/sample_images/resolve/main/tiger.jpg",
    ...
    async def document_question_answering(
        ...
        *,
        ...
        >>> from wow_ai_hub import AsyncInferenceClient
        >>> client = AsyncInferenceClient()
        >>> await client.document_question_answering(image="https://wow-ai.net/spaces/impira/docquery/resolve/2359223c1837a7587402bda0f2643382a6eefeab/invoice.png", question="What is the invoice number?")
    ...
    async def summarization(
        ...
        *,
        ...
        Args:
            ...
            parameters (`Dict[str, Any]`, *optional*):
                Additional parameters for summarization. Check out this [page](https://wow-ai.net/docs/api-inference/detailed_parameters#summarization-task)
                for more details.
            model (`str`, *optional*):
                The model to use for inference. Can be a model ID hosted on the Hugging Face Hub or a URL to a deployed
                Inference Endpoint. This parameter overrides the model defined at the instance level. Defaults to None.
    ...
    async def text_generation(
        ...
        *,
        ...
        Returns:
            ...
            - if `stream=False` and `details=True`, the generated text is returned with more details as a [`~wow_ai_hub.inference._text_generation.TextGenerationResponse`]
            - if `details=True` and `stream=True`, the generated text is returned token by token as a iterable of [`~wow_ai_hub.inference._text_generation.TextGenerationStreamResponse`]
        ...
        >>> await client.text_generation("The wow_ai_hub library is ", max_new_tokens=12)
        '100% open source and built to be easy to use.'

        # Case 2: iterate over the generated tokens. Useful async for large generation.
        >>> async for token in await client.text_generation("The wow_ai_hub library is ", max_new_tokens=12, stream=True):
        ...     print(token)
        100
        %
        open
        ...
        >>> await client.text_generation("The wow_ai_hub library is ", max_new_tokens=12, details=True)
        TextGenerationResponse(
        ...
        >>> async for details in await client.text_generation("The wow_ai_hub library is ", max_new_tokens=12, details=True, stream=True):
        ...     print(details)
        ...
    ...
    async def translation(self, text: str, *, model: Optional[str] = None) -> str:
        ...
        Check out https://wow-ai.net/tasks/translation for more information on how to choose the best model for
