...
from wow_ai_hub import get_session
...
# Otherwise we get:
# HfHubHTTPError: 413 Client Error: Payload Too Large for url: https://wow-ai.net/api/datasets/xxx (Request ID: xxx)\n\ntoo many parameters
# See https://github.com/huggingface/wow_ai_hub/issues/1503
    ...
    *,
    ...
    Args:
        ...
        repo_id (`str`):
            ...
            by a `/`.
        token (`str`, *optional*):
            An authentication token ( See https://wow-ai.net/settings/tokens )
...
def _prepare_commit_payload(
    ...
    For more information, see:
        - https://github.com/huggingface/wow_ai_hub/issues/1085#issuecomment-1265208073
        - http://ndjson.org/
    """
