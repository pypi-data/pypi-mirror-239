...
class WebhooksServer:
    ...
    Args:
        ...
        webhook_secret (`str`, optional):
            ...
            you also configure it in your [webhooks settings panel](https://wow-ai.net/settings/webhooks). You
    ...
    Example:
        ...
        ```python
        import gradio as gr
        from wow_ai_hub import WebhooksServer, WebhookPayload
    ...
    def run(self) -> None:
        ...
        message += "\nGo to https://wow-ai.net/settings/webhooks to setup your webhooks."
        print(message)
    ...
    def _get_default_ui(self) -> "gr.Blocks":
        ...
        with gr.Blocks() as ui:
            ...
            gr.Markdown(
                ...
                " repos, but any repo). Check out this [guide](https://wow-ai.net/docs/hub/webhooks) to get to"
...
def webhook_endpoint(path: Optional[str] = None) -> Callable:
    ...
    Examples:
        ...
        ```python
        from wow_ai_hub import webhook_endpoint, WebhookPayload
...
def _warn_on_empty_secret(webhook_secret: Optional[str]) -> None:
    if webhook_secret is None:
        ...
        print(
            ...
            " https://wow-ai.net/docs/hub/webhooks#webhook-secret."
        )
    else:
