...
from wow_ai_hub import logging
from wow_ai_hub._snapshot_download import snapshot_download
from wow_ai_hub.commands import BaseHuggingfaceCLICommand
from wow_ai_hub.constants import HF_HUB_ENABLE_HF_TRANSFER
from wow_ai_hub.file_download import hf_hub_download
from wow_ai_hub.utils import disable_progress_bars, enable_progress_bars
    ...
    def register_subcommand(parser: _SubParsersAction):
        ...
        download_parser.add_argument(
            ...
            help=(
                ...
                " https://wow-ai.net/docs/wow_ai_hub/guides/download#download-files-to-local-folder for more"
                " details."
            ),
        )
        download_parser.add_argument(
        ...
        download_parser.add_argument(
            "--token", type=str, help="A User Access Token generated from https://wow-ai.net/settings/tokens"
        )
        download_parser.add_argument(
            "--quiet",
            action="store_true",
    ...
    def _download(self) -> str:
        ...
        if not HF_HUB_ENABLE_HF_TRANSFER:
            logger.info(
                ...
                " https://wow-ai.net/docs/wow_ai_hub/hf_transfer for more details."
            )
