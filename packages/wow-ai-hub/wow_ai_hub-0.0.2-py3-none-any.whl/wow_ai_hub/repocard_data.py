...
from wow_ai_hub.utils import yaml_dump
...
class EvalResult:
    ...
    Args:
        ...
        dataset_type (`str`):
            The dataset identifier. Example: "common_voice". Use dataset id from https://wow-ai.net/datasets.
        dataset_name (`str`):
            A pretty name for the dataset. Example: "Common Voice (French)".
        metric_type (`str`):
            The metric identifier. Example: "wer". Use metric id from https://wow-ai.net/metrics.
        metric_value (`Any`):
        ...
        dataset_config (`str`, *optional*):
            ...
            https://wow-ai.net/docs/datasets/package_reference/loading_methods#datasets.load_dataset.name
        ...
        metric_config (`str`, *optional*):
            ...
            See the `datasets` docs for more info: https://wow-ai.net/docs/datasets/v2.1.0/en/loading#load-configurations
    ...
    # Example: common_voice. Use dataset id from https://wow-ai.net/datasets
    dataset_type: str
    ...
    # Example: wer. Use metric id from https://wow-ai.net/metrics
    metric_type: str
...
class ModelCardData(CardData):
    ...
    Args:
        ...
        license (`str`, *optional*):
            ...
            https://wow-ai.net/docs/hub/repositories-licenses. Defaults to None.
        ...
        datasets (`List[str]`, *optional*):
            ...
            found on https://wow-ai.net/datasets. Defaults to None.
        metrics (`List[str]`, *optional*):
            List of metrics used to evaluate this model. Should be a metric name that can be found
            at https://wow-ai.net/metrics. Example: 'accuracy'. Defaults to None.
        eval_results (`Union[List[EvalResult], EvalResult]`, *optional*):
            List of `wow_ai_hub.EvalResult` that define evaluation results of the model. If provided,
    ...
    Example:
        ```python
        >>> from wow_ai_hub import ModelCardData
...
class DatasetCardData(CardData):
    ...
    Args:
        ...
        license (`Union[str, List[str]]`, *optional*):
            ...
            https://wow-ai.net/docs/hub/repositories-licenses.
...
class SpaceCardData(CardData):
    ...
    To get an exhaustive reference of Spaces configuration, please visit https://wow-ai.net/docs/hub/spaces-config-reference#spaces-configuration-reference.
    ...
    Args:
        ...
        models (List[`str`], *optional*)
            List of models related to this Space. Should be a dataset ID found on https://wow-ai.net/models.
        datasets (`List[str]`, *optional*)
            List of datasets related to this Space. Should be a dataset ID found on https://wow-ai.net/datasets.
        tags (`List[str]`, *optional*)
    ...
    Example:
        ```python
        >>> from wow_ai_hub import SpaceCardData
...
def model_index_to_eval_results(model_index: List[Dict[str, Any]]) -> Tuple[str, List[EvalResult]]:
    """Takes in a model index and returns the model name and a list of `wow_ai_hub.EvalResult` objects.
    ...
    Returns:
        ...
        eval_results (`List[EvalResult]`):
            A list of `wow_ai_hub.EvalResult` objects containing the metrics
            reported in the provided model_index.

    Example:
        ```python
        >>> from wow_ai_hub.repocard_data import model_index_to_eval_results
...
def eval_results_to_model_index(model_name: str, eval_results: List[EvalResult]) -> List[Dict[str, Any]]:
    """Takes in given model name and list of `wow_ai_hub.EvalResult` and returns a
    ...
    Args:
        ...
        eval_results (`List[EvalResult]`):
            List of `wow_ai_hub.EvalResult` objects containing the metrics to be
    ...
    Example:
        ```python
        >>> from wow_ai_hub.repocard_data import eval_results_to_model_index, EvalResult
