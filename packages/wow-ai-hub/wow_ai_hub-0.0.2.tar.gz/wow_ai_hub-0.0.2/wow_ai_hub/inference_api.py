...
class InferenceApi:
    ...
    ```python
    >>> from wow_ai_hub.inference_api import InferenceApi
    ...
    @_deprecate_method(
        ...
        message=(
            ...
            " https://wow-ai.net/docs/wow_ai_hub/guides/inference#legacy-inferenceapi-client."
        ),
    )
    def __init__(
        self,
        ...
        Args:
            ...
            token (`str`, `optional`):
                ...
                https://wow-ai.net/settings/token. Alternatively, you can
        ...
        if not model_info.pipeline_tag and not task:
            raise ValueError(
                ...
                " using pipeline_tag"
                " (https://wow-ai.net/docs#how-is-a-models-type-of-inference-api-and-widget-determined)"
            )
