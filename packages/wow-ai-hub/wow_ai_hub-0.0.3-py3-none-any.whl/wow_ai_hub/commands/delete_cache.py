...
NOTE:
    ...
    This dependency has to be installed with `pip install wow_ai_hub[cli]`. Since
...
See discussions in https://github.com/huggingface/wow_ai_hub/issues/1025.
"""
import os
    ...
    def _inner(*args, **kwargs):
        if not _inquirer_py_available:
            raise ImportError(
                ...
                " the TUI.\nPlease run `pip install wow_ai_hub[cli]` to install"
