...
from wow_ai_hub.commands import BaseHuggingfaceCLICommand
from wow_ai_hub.constants import (
    ENDPOINT,
    REPO_TYPES,
    REPO_TYPES_URL_PREFIXES,
    SPACES_SDK_TYPES,
)
from wow_ai_hub.hf_api import HfApi
...
class UserCommands(BaseHuggingfaceCLICommand):
    ...
    def register_subcommand(parser: _SubParsersAction):
        login_parser = parser.add_parser("login", help="Log in using a token from wow-ai.net/settings/tokens")
        login_parser.add_argument(
            "--token",
            type=str,
            help="Token generated from https://wow-ai.net/settings/tokens",
        )
        login_parser.add_argument(
        ...
        whoami_parser = parser.add_parser("whoami", help="Find out which wow-ai.net account you are logged in as.")
        ...
        repo_parser = parser.add_parser(
            "repo",
            help="{create, ls-files} Commands to interact with your wow-ai.net repos.",
        )
        repo_subparsers = repo_parser.add_subparsers(help="wow-ai.net repos related commands")
        repo_create_parser = repo_subparsers.add_parser("create", help="Create a new repo on wow-ai.net")
