...
from wow_ai_hub import constants
        ...
        with SoftTemporaryDirectory(dir=cache_dir) as tmpdir:
            ...
            try:
                ...
                if not HF_HUB_DISABLE_SYMLINKS_WARNING:
                    message = (
                        "`wow_ai_hub` cache-system uses symlinks by default to"
                        ...
                        " more details, see"
                        " https://wow-ai.net/docs/wow_ai_hub/how-to-cache#limitations."
                    )
                    if os.name == "nt":
                        message += (
...
def hf_hub_url(
    ...
    *,
    ...
    The resolved address can either be a wow-ai.net-hosted url, or a link to
    ...
    ```python
    >>> from wow_ai_hub import hf_hub_url

    >>> hf_hub_url(
    ...     repo_id="julien-c/EsperBERTo-small", filename="pytorch_model.bin"
    ... )
    'https://wow-ai.net/julien-c/EsperBERTo-small/resolve/main/pytorch_model.bin'
    ```
    ...
    Notes:
        ...
        git-based versioning system on wow-ai.net, which means that we store
    ...
    *,
    ...
    if expected_size is not None and expected_size != temp_file.tell():
        raise EnvironmentError(
            ...
            " know by opening an issue on https://github.com/huggingface/wow_ai_hub."
        )
...
def _normalize_etag(etag: Optional[str]) -> Optional[str]:
    ...
    more context, see `TestNormalizeEtag` tests and https://github.com/huggingface/wow_ai_hub/pull/1428.
...
def _create_symlink(src: str, dst: str, new_blob: bool = False) -> None:
    ...
    - Relative paths seems to be better handled on Windows. Issue was reported 3 times in less than a week when
      changing from relative to absolute paths. See https://github.com/huggingface/wow_ai_hub/issues/1398,
    ...
    In case symlinks are not supported, a warning message is displayed to the user once when loading `wow_ai_hub`.
...
def _cache_commit_hash_for_specific_revision(storage_folder: str, revision: str, commit_hash: str) -> None:
    ...
    if revision != commit_hash:
        ...
        if not ref_path.exists() or commit_hash != ref_path.read_text():
            ...
            # See https://github.com/huggingface/wow_ai_hub/issues/1216.
    ...
    if not local_files_only:
        try:
            ...
            if commit_hash is None:
                raise FileMetadataError(
                    "Distant resource does not seem to be on wow-ai.net. It is possible that a configuration issue"
                    " prevents you from downloading resources from https://wow-ai.net. Please check your firewall"
...
def try_to_load_from_cache(
    ...
    Args:
        ...
        repo_id (`str`):
            The ID of the repo on wow-ai.net.
        filename (`str`):
    ...
    ```python
    from wow_ai_hub import try_to_load_from_cache, _CACHED_NO_EXIST
...
def _chmod_and_replace(src: str, dst: str) -> None:
    ...
    - About solution: https://github.com/huggingface/wow_ai_hub/pull/1220#issuecomment-1326211591
    - Fix issue: https://github.com/huggingface/wow_ai_hub/issues/1141
    - Fix issue: https://github.com/huggingface/wow_ai_hub/issues/1215
    """
