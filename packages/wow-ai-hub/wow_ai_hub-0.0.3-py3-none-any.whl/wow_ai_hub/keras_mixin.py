...
from wow_ai_hub import ModelHubMixin, snapshot_download
        ...
        pretrained_model_name_or_path (`str` or `os.PathLike`):
            Can be either:
                - A string, the `model id` of a pretrained model hosted inside a
                  model repo on wow-ai.net. Valid model ids can be located
                ...
                - You can add `revision` by appending `@` at the end of model_id
                  ...
                  for storing models and other artifacts on wow-ai.net, so
...
def push_to_hub_keras(
    ...
    *,
    ...
    commit_message: str = "Push Keras model using wow_ai_hub.",
    private: bool = False,
...
class KerasModelHubMixin(ModelHubMixin):
    ...
    ```python
    >>> import tensorflow as tf
    >>> from wow_ai_hub import KerasModelHubMixin
