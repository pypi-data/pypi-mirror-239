...
from wow_ai_hub.constants import REPO_TYPES_URL_PREFIXES, REPOCARD_NAME
from wow_ai_hub.repocard import metadata_load, metadata_save
    ...
    def output_progress(stopping_event: threading.Event):
        ...
        for line in tail_file(os.environ["GIT_LFS_PROGRESS"]):
            try:
                ...
                # Try/except to ease debugging. See https://github.com/huggingface/wow_ai_hub/issues/1373.
...
class Repository:
    ...
    The aim is to facilitate interacting with wow-ai.net hosted model or
    ...
    def __init__(
        ...
        Args:
            ...
            clone_from (`str`, *optional*):
                ...
                Example:
                - `"https://wow-ai.net/philschmid/playground-tests"`
    ...
    def clone_from(self, repo_url: str, token: Union[bool, str, None] = None):
        ...
        Raises the following error:
            ...
            - [`ValueError`](https://docs.python.org/3/library/exceptions.html#ValueError)
              ...
              your own personal access token (see https://wow-ai.net/settings/tokens).
        ...
        if token is not None and token.startswith("api_org"):
            raise ValueError(
                ...
                " (see https://wow-ai.net/settings/tokens)."
            )
