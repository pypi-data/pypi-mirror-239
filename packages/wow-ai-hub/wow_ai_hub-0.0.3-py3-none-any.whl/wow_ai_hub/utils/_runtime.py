...
try:
    ...
    # warning disappear. See https://github.com/huggingface/wow_ai_hub/issues/1043
    #
...
def dump_environment_info() -> Dict[str, Any]:
    ...
    """
    from wow_ai_hub import HfFolder, whoami
    from wow_ai_hub.utils import list_credential_helpers

    token = HfFolder().get_token()

    # Generic machine info
    info: Dict[str, Any] = {
        "wow_ai_hub version": get_hf_hub_version(),
    ...
    info["wow_ai_hub_CACHE"] = constants.wow_ai_hub_CACHE
