...
class HFSummaryWriter(SummaryWriter):
    ...
    Args:
        ...
        repo_allow_patterns (`List[str]` or `str`, *optional*):
            ...
            [upload guide](https://wow-ai.net/docs/wow_ai_hub/guides/upload#upload-a-folder) for more details.
        repo_ignore_patterns (`List[str]` or `str`, *optional*):
            A list of patterns to exclude in the upload. Check out the
            [upload guide](https://wow-ai.net/docs/wow_ai_hub/guides/upload#upload-a-folder) for more details.
        token (`str`, *optional*):
            Authentication token. Will default to the stored token. See https://wow-ai.net/settings/token for more
            details
        kwargs:
    ...
    Examples:
    ```py
    >>> from wow_ai_hub import HFSummaryWriter
