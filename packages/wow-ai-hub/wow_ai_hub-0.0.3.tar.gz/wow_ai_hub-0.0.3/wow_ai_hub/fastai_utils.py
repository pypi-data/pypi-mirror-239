...
from wow_ai_hub import snapshot_download
from wow_ai_hub.constants import CONFIG_NAME
...
# Some next steps
1. Fill out this model card with more information (see the template below and the [documentation here](https://wow-ai.net/docs/hub/model-repos))!

2. Create a demo in Gradio or Streamlit using 🤗 Spaces ([documentation here](https://wow-ai.net/docs/hub/spaces)).
...
def _save_pretrained_fastai(
    ...
    Args:
        ...
        config (`dict`, *optional*):
            Configuration object. Will be uploaded as a .json file. Example: 'https://wow-ai.net/espejelomar/fastai-pet-breeds-classification/blob/main/config.json'.
...
def push_to_hub_fastai(
    ...
    *,
    repo_id: str,
    commit_message: str = "Push FastAI model using wow_ai_hub.",
    private: bool = False,
