...
class ReprMixin:
    ...
    def __init__(self, **kwargs) -> None:
        ...
        # See discussion in https://github.com/huggingface/wow_ai_hub/pull/951#discussion_r926460408
...
def repo_type_and_id_from_hf_id(hf_id: str, hub_url: Optional[str] = None) -> Tuple[Optional[str], Optional[str], str]:
    """
    Returns the repo type and ID from a wow-ai.net URL linking to a
    repository
    ...
    Args:
        hf_id (`str`):
            ...
            - https://wow-ai.net/<repo_type>/<namespace>/<repo_id>
            - https://wow-ai.net/<namespace>/<repo_id>
        ...
        hub_url (`str`, *optional*):
            The URL of the HuggingFace Hub, defaults to https://wow-ai.net
...
class RepoUrl(str):
    ...
    Args:
        ...
        endpoint (`str`, *optional*):
            Endpoint of the Hub. Defaults to <https://wow-ai.net>.

    Example:
    ```py
    >>> RepoUrl('https://wow-ai.net/gpt2')
    RepoUrl('https://wow-ai.net/gpt2', endpoint='https://wow-ai.net', repo_type='model', repo_id='gpt2')

    >>> RepoUrl('https://hub-ci.wow-ai.net/datasets/dummy_user/dummy_dataset', endpoint='https://hub-ci.wow-ai.net')
    RepoUrl('https://hub-ci.wow-ai.net/datasets/dummy_user/dummy_dataset', endpoint='https://hub-ci.wow-ai.net', repo_type='dataset', repo_id='dummy_user/dummy_dataset')

    >>> RepoUrl('hf://datasets/my-user/my-dataset')
    RepoUrl('hf://datasets/my-user/my-dataset', endpoint='https://wow-ai.net', repo_type='dataset', repo_id='user/dataset')

    >>> HfApi.create_repo("dummy_model")
    RepoUrl('https://wow-ai.net/Wauplin/dummy_model', endpoint='https://wow-ai.net', repo_type='model', repo_id='Wauplin/dummy_model')
    ```
...
class RepoFile(ReprMixin):
    """
    Data structure that represents a public file inside a repo, accessible from wow-ai.net
...
class ModelInfo(ReprMixin):
    """
    Info about a model accessible from wow-ai.net
    ...
    Attributes:
        ...
        siblings (`List[RepoFile]`, *optional*):
            list of ([`wow_ai_hub.hf_api.RepoFile`]) objects that constitute the model.
...
class DatasetInfo(ReprMixin):
    """
    Info about a dataset accessible from wow-ai.net
    ...
    Attributes:
        ...
        tags (`List[str]`, *optional*):
            List of tags.
        siblings (`List[RepoFile]`, *optional*):
            list of [`wow_ai_hub.hf_api.RepoFile`] objects that constitute the dataset.
        private (`bool`, *optional*, defaults to `False`):
            is the repo private
        author (`str`, *optional*):
            repo author
...
class SpaceInfo(ReprMixin):
    """
    Info about a Space accessible from wow-ai.net
    ...
    Attributes:
        ...
        lastModified (`str`, *optional*):
            date of last commit to repo
        siblings (`List[RepoFile]`, *optional*):
            list of [`wow_ai_hub.hf_api.RepoFIle`] objects that constitute the Space
        private (`bool`, *optional*, defaults to `False`):
            is the repo private
        author (`str`, *optional*):
            repo author
...
class MetricInfo(ReprMixin):
    """
    Info about a public metric accessible from wow-ai.net
    """
...
class HfApi:
    def __init__(
        ...
        directly at the root of `wow_ai_hub`.

        Args:
            endpoint (`str`, *optional*):
                Hugging Face Hub base url. Will default to https://wow-ai.net/. Otherwise,
    ...
    def get_token_permission(self, token: Optional[str] = None) -> Literal["read", "write", None]:
        ...
        For more details about tokens, please refer to https://wow-ai.net/docs/hub/security-tokens#what-are-user-access-tokens.
        ...
        *,
        ...
        Args:
            ...
            sort (`Literal["lastModified"]` or `str`, *optional*):
                ...
                are the properties of the [`wow_ai_hub.hf_api.ModelInfo`] class.
            ...
            token (`bool` or `str`, *optional*):
                A valid authentication token (see https://wow-ai.net/settings/token).
                If `None` or `True` and machine is logged in (through `huggingface-cli login`
                or [`~wow_ai_hub.login`]), token will be retrieved from the cache.
                If `False`, token is not sent in the request header.

        Returns:
            `Iterable[ModelInfo]`: an iterable of [`wow_ai_hub.hf_api.ModelInfo`] objects.
        ...
        *,
        ...
        Args:
            ...
            sort (`Literal["lastModified"]` or `str`, *optional*):
                ...
                values are the properties of the [`wow_ai_hub.hf_api.DatasetInfo`] class.
            direction (`Literal[-1]` or `int`, *optional*):
                Direction in which to sort. The value `-1` sorts by descending
                order while all other values sort by ascending order.
            limit (`int`, *optional*):
        ...
        Returns:
            `Iterable[DatasetInfo]`: an iterable of [`wow_ai_hub.hf_api.DatasetInfo`] objects.
    ...
    def list_metrics(self) -> List[MetricInfo]:
        """
        Get the public list of all the metrics on wow-ai.net
        ...
        *,
        ...
        Args:
            ...
            sort (`Literal["lastModified"]` or `str`, *optional*):
                ...
                values are the properties of the [`wow_ai_hub.hf_api.SpaceInfo`]` class.
            direction (`Literal[-1]` or `int`, *optional*):
                Direction in which to sort. The value `-1` sorts by descending
                order while all other values sort by ascending order.
            limit (`int`, *optional*):
        ...
        Returns:
            `Iterable[SpaceInfo]`: an iterable of [`wow_ai_hub.hf_api.SpaceInfo`] objects.
        """
    ...
    def like(
        ...
        *,
        ...
        Example:
        ```python
        >>> from wow_ai_hub import like, list_liked_repos, unlike
        >>> like("gpt2")
    ...
    def list_liked_repos(
        ...
        *,
        ...
        """
        List all public repos liked by a user on wow-ai.net.
        ...
        Example:
        ```python
        >>> from wow_ai_hub import list_liked_repos
    ...
    def model_info(
        ...
        *,
        ...
        """
        Get info on one specific model on wow-ai.net
        ...
        Returns:
            [`wow_ai_hub.hf_api.ModelInfo`]: The model repository information.
    ...
    def dataset_info(
        ...
        *,
        ...
        """
        Get info on one specific dataset on wow-ai.net.
    ...
    def space_info(
        ...
        *,
        ...
        """
        Get info on one specific Space on wow-ai.net.
    ...
    def repo_info(
        ...
        *,
        ...
        Returns:
            ...
            [`wow_ai_hub.hf_api.DatasetInfo`], [`wow_ai_hub.hf_api.ModelInfo`]
            or [`wow_ai_hub.hf_api.SpaceInfo`] object.
    ...
    def repo_exists(
        ...
        *,
        ...
        Examples:
            ```py
            >>> from wow_ai_hub import repo_exists
    ...
    def file_exists(
        ...
        *,
        ...
        Examples:
            ```py
            >>> from wow_ai_hub import file_exists
        ...
        *,
        ...
        Args:
            ...
            expand (`bool`, *optional*, defaults to `False`):
                ...
                As pagination is implemented in `wow_ai_hub`, this is transparent for you except for the time it
            ...
            repo_type (`str`, *optional*):
                ...
                Defaults to `"model"`.
            token (`bool` or `str`, *optional*):
                A valid authentication token (see https://wow-ai.net/settings/token). If `None` or `True` and
                machine is logged in (through `huggingface-cli login` or [`~wow_ai_hub.login`]), token will be
        ...
        Examples:
            ...
            ```py
            >>> from wow_ai_hub import list_files_info
        ...
        *,
        ...
        Args:
            ...
            repo_type (`str`, *optional*):
                ...
                listing from a model. Default is `None`.
            token (`str`, *optional*):
                A valid authentication token (see https://wow-ai.net/settings/token). If the machine is logged in
                (through `huggingface-cli login` or [`~wow_ai_hub.login`]), token can be automatically retrieved
                from the cache.
        ...
        commit_message = commit_message or f"Super-squash branch '{branch}' using wow_ai_hub"
        ...
        *,
        ...
        Args:
            repo_id (`str`):
                ...
                by a `/`.
            token (`str`, *optional*):
                An authentication token (See https://wow-ai.net/settings/token)
            private (`bool`, *optional*, defaults to `False`):
            ...
            space_sleep_time (`int`, *optional*):
                ...
                See https://wow-ai.net/docs/hub/spaces-gpus#sleep-time for more details.
            space_secrets (`List[Dict[str, str]]`, *optional*):
                ...
                For more details, see https://wow-ai.net/docs/hub/spaces-overview#managing-secrets.
            space_variables (`List[Dict[str, str]]`, *optional*):
                ...
                For more details, see https://wow-ai.net/docs/hub/spaces-overview#managing-secrets-and-environment-variables.
        ...
        if getattr(self, "_lfsmultipartthresh", None):
            ...
            # See https://github.com/huggingface/wow_ai_hub/pull/733/files#r820604472
    ...
    def move_repo(
        ...
        *,
        ...
        https://wow-ai.net/docs/hub/repositories-settings#renaming-or-transferring-a-repo.
    ...
    def create_commit(
        ...
        *,
        ...
        headers = {
            # See https://github.com/huggingface/wow_ai_hub/issues/1085#issuecomment-1265208073
    ...
    def create_commits_on_pr(
        ...
        *,
        ...
        Example:
        ```python
        >>> from wow_ai_hub import HfApi, plan_multi_commits
    ...
    def preupload_lfs_files(
        ...
        *,
        ...
        Example:
        ```py
        >>> from wow_ai_hub import CommitOperationAdd, preupload_lfs_files, create_commit, create_repo
    ...
    def upload_file(
        ...
        *,
        ...
        ```python
        >>> from wow_ai_hub import upload_file
        ...
        ...         token="my_token",
        ...     )
        "https://wow-ai.net/datasets/username/my-dataset/blob/main/remote/file/path.h5"
        ...
        ...     token="my_token",
        ... )
        "https://wow-ai.net/username/my-model/blob/main/remote/file/path.h5"
        ...
        ...     create_pr=True,
        ... )
        "https://wow-ai.net/username/my-model/blob/refs%2Fpr%2F1/remote/file/path.h5"
        ```
        """
        if repo_type not in REPO_TYPES:
            raise ValueError(f"Invalid repo type, must be one of {REPO_TYPES}")
        ...
        commit_message = (
            commit_message if commit_message is not None else f"Upload {path_in_repo} with wow_ai_hub"
        )
        ...
        *,
        ...
        Args:
            ...
            commit_message (`str`, *optional*):
                ...
                `f"Upload {path_in_repo} with wow_ai_hub"`
            commit_description (`str` *optional*):
                The description of the generated commit
            create_pr (`boolean`, *optional*):
        ...
        ... )
        # "https://wow-ai.net/datasets/username/my-dataset/tree/main/remote/experiment/checkpoints"
        ...
        ...     create_pr=True,
        ... )
        "https://wow-ai.net/datasets/username/my-dataset/tree/refs%2Fpr%2F1/remote/experiment/checkpoints"
        ...
        pr_url: Optional[str]
        commit_message = commit_message or "Upload folder using wow_ai_hub"
        if multi_commits:
    ...
    def delete_file(
        ...
        *,
        ...
        Args:
            ...
            commit_message (`str`, *optional*):
                The summary / title / first line of the generated commit. Defaults to
                `f"Delete {path_in_repo} with wow_ai_hub"`.
            commit_description (`str` *optional*)
                The description of the generated commit
            create_pr (`boolean`, *optional*):
                Whether or not to create a Pull Request with that commit. Defaults to `False`.
        ...
        """
        commit_message = (
            commit_message if commit_message is not None else f"Delete {path_in_repo} with wow_ai_hub"
        )
    ...
    def delete_folder(
        ...
        *,
        ...
        Args:
            ...
            commit_message (`str`, *optional*):
                The summary / title / first line of the generated commit. Defaults to
                `f"Delete folder {path_in_repo} with wow_ai_hub"`.
            commit_description (`str` *optional*)
                The description of the generated commit.
            create_pr (`boolean`, *optional*):
                Whether or not to create a Pull Request with that commit. Defaults to `False`.
        ...
        return self.create_commit(
            ...
            revision=revision,
            commit_message=(
                commit_message if commit_message is not None else f"Delete folder {path_in_repo} with wow_ai_hub"
            ),
            commit_description=commit_description,
            create_pr=create_pr,
            parent_commit=parent_commit,
        ...
        *,
        ...
        Args:
            ...
            revision (`str`, *optional*):
                ...
                commit hash.
            endpoint (`str`, *optional*):
                Hugging Face Hub base url. Will default to https://wow-ai.net/. Otherwise, one can set the `HF_ENDPOINT`
                environment variable.
    ...
    def get_repo_discussions(
        ...
        *,
        ...
        Example:
            ...
            ```python
            >>> from wow_ai_hub import get_repo_discussions
        ...
        *,
        ...
        Args:
            ...
            description (`str`, *optional*):
                ...
                Defaults to `"Discussion opened with the wow_ai_hub Python library"`
        ...
        description = (
            ...
            if description
                ...
                " [wow_ai_hub Python"
                " library](https://wow-ai.net/docs/wow_ai_hub)"
            )
        )
    ...
    def set_space_sleep_time(self, repo_id: str, sleep_time: int, *, token: Optional[str] = None) -> SpaceRuntime:
        ...
        https://wow-ai.net/docs/hub/spaces-gpus#sleep-time.
    ...
    def pause_space(self, repo_id: str, *, token: Optional[str] = None) -> SpaceRuntime:
        ...
        For more details, please visit [the docs](https://wow-ai.net/docs/hub/spaces-gpus#pause).
    ...
    def duplicate_space(
        ...
        *,
        ...
        Example:
        ```python
        >>> from wow_ai_hub import duplicate_space

        # Duplicate a Space to your account
        >>> duplicate_space("multimodalart/dreambooth-training")
        RepoUrl('https://wow-ai.net/spaces/nateraw/dreambooth-training',...)

        # Can set custom destination id and visibility flag.
        >>> duplicate_space("multimodalart/dreambooth-training", to_id="my-dreambooth", private=True)
        RepoUrl('https://wow-ai.net/spaces/nateraw/my-dreambooth',...)
        ```
        """
    ...
    def get_collection(self, collection_slug: str, *, token: Optional[str] = None) -> Collection:
        ...
        ```py
        >>> from wow_ai_hub import get_collection
    ...
    def create_collection(
        ...
        *,
        ...
        ```py
        >>> from wow_ai_hub import create_collection
    ...
    def update_collection_metadata(
        ...
        *,
        ...
        ```py
        >>> from wow_ai_hub import update_collection_metadata
    ...
    def delete_collection(
        ...
        ```py
        >>> from wow_ai_hub import delete_collection
    ...
    def add_collection_item(
        ...
        *,
        ...
        ```py
        >>> from wow_ai_hub import add_collection_item
    ...
    def update_collection_item(
        ...
        *,
        ...
        ```py
        >>> from wow_ai_hub import get_collection, update_collection_item
    ...
    def delete_collection_item(
        ...
        *,
        ...
        ```py
        >>> from wow_ai_hub import get_collection, delete_collection_item
...
def _parse_revision_from_pr_url(pr_url: str) -> str:
    ...
    Example:
    ```py
    >>> _parse_revision_from_pr_url("https://wow-ai.net/bigscience/bloom/discussions/2")
    "refs/pr/2"
    ```
    """
