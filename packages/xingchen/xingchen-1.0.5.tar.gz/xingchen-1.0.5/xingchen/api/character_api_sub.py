...
class CharacterApiSub:
    ...
    def create_or_update_version_with_http_info(self, character_version_create_or_update_dto: Annotated[
        ...
        return self.api_client.call_api(
            '/{0}/api/character/createOrUpdateVersion'.format(self.api_client.api_version()), 'PUT',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def delete_with_http_info(self, character_id: Annotated[StrictStr, Field(..., description="待删除的 characterId")],
        ...
        return self.api_client.call_api(
            '/{0}/api/character/delete'.format(self.api_client.api_version()), 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def update_with_http_info(self, character_update_dto: Annotated[
        ...
        return self.api_client.call_api(
            '/{0}/api/character/update'.format(self.api_client.api_version()), 'PUT',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
