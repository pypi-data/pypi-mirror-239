...
class Z3solver:
    ...
    def run_implicit_labeling(self, labler, parallel: bool = True):
    ...
    def implicit_labeling(self, removed_node: str = None, queue = None, this_ctx=None):
        ...
        # print(Fore.GREEN + f'{s.ctx = }, {s.ctx.owner = }' + Style.RESET_ALL)
        # print(Fore.GREEN + f"Solver instance ID: {id(s)}" + Style.RESET_ALL)
