...
def init_job(result_map: Dict[str, List], spider_ids: List[str], task_queue_suffix: str) -> (Dict[str, List[StreamTaskItem]], List[dict], str):
    for spider_id in spider_ids:
        ...
        if not spider_conf:
            ...
            if task_items:
                ...
                # task_items = [x.to_classify_result() for x in task_items]
